...
def main():
    ...
    print("  Expiry: 15 minutes")
    print("  Use: API requests")
    ...
    print("  Expiry: 7 days")
    print("  Use: Refresh expired access tokens")
    ...
    print("  Expiry: 30 days (with inactivity timeout)")
    ...
    print("✓ Created 2 additional sessions")
