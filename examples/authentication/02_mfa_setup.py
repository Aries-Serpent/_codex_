...
def display_qr_instructions():
    ...
    # The provisioning URI passed into this function contains the secret and is
    # therefore intentionally not printed to stdout in this example.
    print("\n[INFO]: Provisioning URI was generated by the caller but is not")
    print("        displayed here for security reasons.\n")
    ...
    print("  Account: user@example.com")
