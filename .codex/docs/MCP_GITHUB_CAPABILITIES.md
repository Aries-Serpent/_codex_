...
> companion MCP references are aligned to this 36-tool runtime surface as of
> 2026-08-01.
...
| Runtime inventory can change | The 36-tool list is a dated runtime observation rather than a permanent contract | Recheck the MCP startup inventory before publishing a new count. |
