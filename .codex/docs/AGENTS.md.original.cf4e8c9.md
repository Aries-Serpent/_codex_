...
3. **Key Constraints:** See <!-- BROKEN LINK: <!-- BROKEN LINK: <!-- BROKEN LINK: <!-- BROKEN LINK: [.codex/guardrails.md](.codex/guardrails.md) --> --> --> -->
...
1. **<!-- BROKEN LINK: <!-- BROKEN LINK: <!-- BROKEN LINK: <!-- BROKEN LINK: [.codex/guardrails.md](.codex/guardrails.md) --> --> --> -->** - Operational constraints (5 min)
