...
| Medium | `OFFLINE_DEPLOYMENT.md:421` | `QUICKSTART_BY_PROFILE.md#-core-profile-lightweight--offline-first-8-15-mb` | Follow-up required in the referenced file: use `#core-profile-lightweight-offline-first-8-15-mb` (remove emoji/special markers) |
| Medium | `OFFLINE_DEPLOYMENT.md:422` | `QUICKSTART_BY_PROFILE.md#-runtime-profile-production-inference--apis-20-35-mb` | Follow-up required in the referenced file: use `#runtime-profile-production-inference-apis-20-35-mb` (remove emoji/special markers) |
