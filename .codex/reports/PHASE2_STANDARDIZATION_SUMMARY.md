...
```text
docs/arch/
├── adr-2024-11-02-archive-sigstore-integration.md      (NEW) - 180 lines
├── adr-2024-11-03-evidence-schema-versioning.md        (NEW) - 200 lines
└── _archive-policy/
...
```python
{
  ...
  "signed_at": "2024-11-03T00:00:00Z"
}
```text
...
1. **ADR-2024-11-02**: Sigstore Keyless Signing Integration
   - Why Sigstore over GPG/TUF
   - SLSA L3 alignment
   - GitHub OIDC integration

2. **ADR-2024-11-03**: Evidence Schema Versioning
