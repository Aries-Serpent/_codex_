...
## Documentation
- [Genesis Protocol](Genesis-Protocol.md)
  - [Phase 1: Templates](Genesis-Protocol.md#phase-1-template-creation--complete)
  - [Phase 2: Activation](Genesis-Protocol.md#phase-2-human-activation--pending)
  - [Phase 3: Operations](Genesis-Protocol.md#phase-3-autonomous-operations--future)
- [Agent Operations](Agent-Operations.md)
  - [Decision Framework](Agent-Operations.md#decision-making-framework)
  - [Risk Assessment](Agent-Operations.md#risk-assessment-matrix)
  - [Escalation](Agent-Operations.md#escalation-procedures)
  - [Error Handling](Agent-Operations.md#error-handling)
- [Runtime Variables](https://github.com/Aries-Serpent/_codex_/blob/main/.codex/runtime_variables.md)

## Security
- [Security Policy](https://github.com/Aries-Serpent/_codex_/blob/main/SECURITY.md)
- [Security Scan Reports](https://github.com/Aries-Serpent/_codex_/blob/main/.codex/security_vulnerability_scan_2025-12-26.md)
- [Vulnerability Handling](Genesis-Protocol.md#security-considerations)

## Configuration
- [Environment Variables](https://github.com/Aries-Serpent/_codex_/blob/main/.codex/runtime_variables.md)
- [Hydra Configs](Home.md#key-components)
- [Guardrails](https://github.com/Aries-Serpent/_codex_/blob/main/.codex/guardrails.md)
