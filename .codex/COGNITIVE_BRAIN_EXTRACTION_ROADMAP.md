# COGNITIVE BRAIN EXTRACTION ROADMAP

## Phase 0-5: Modular Decoupling & PyPI Distribution Strategy

**Campaign:** Cognitive Brain-Powered Packaging  
**Timeline:** Weeks 1-16 (Aug 2026 - Nov 2026)  
**Authority:** @mbaetiong D-tier  

**Scope:** Extract monolithic `_codex_` into 4+ independent PyPI packages with clear, stable APIs and minimal inter-dependencies.
...
## Integration with Packaging Campaign

**This roadmap is Phase 2-5 of the larger Packaging Campaign:**

- **Packaging Campaign Phase 1:** Packaging profiles, offline bootstrap (in LANE_1_BRIEF, LANE_2_BRIEF)
- **Extraction Roadmap Phase 1:** LITE profile extraction
- **Extraction Roadmap Phase 2:** COGNITIVE CORE extraction
- **Extraction Roadmap Phase 3-5:** ML, Services, Advanced modules

**Timeline alignment:**
- Packaging Campaign target: 2026-08-15
- Extraction Roadmap target: 2026-11-30 (16-week follow-up)

**Authority:** Same (@mbaetiong D-tier); sequential execution after Packaging Campaign Phase 0-4 complete.
