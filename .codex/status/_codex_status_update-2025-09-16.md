...
*Risk:* Splitting large datasets Phase 5 exhaust memory; ratios may not sum to 1.0. Use streaming splitting for large files in future. The utility writes new files in the same directory, potentially overwriting existing splits.
