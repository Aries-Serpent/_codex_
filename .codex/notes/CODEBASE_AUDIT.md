...
- **Full multi-node distributed training:** While single-node multi-GPU support is important, adding multi-node support requires significant engineering and Phase 5 not be necessary for the current scale. Defer until model sizes demand it.
