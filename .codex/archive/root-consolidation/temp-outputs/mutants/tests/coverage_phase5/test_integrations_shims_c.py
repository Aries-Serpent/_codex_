"""Test integration shims module 2."""
...
async def test_shim_2_init():
    """Test shim initialization."""
    shim = ExternalServiceShim("service_2")
    assert shim.service_name == "service_2", "service_name is not valid"


@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_2_activate():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_2_shutdown():
    """Test shim shutdown."""
    shim = ExternalServiceShim("service_2")
    await shim.initialize()
