...
```
_codex_/
├── README_PR_3133_ANALYSIS.md          ⭐ START HERE - Navigation guide
│
├── .codex/
...
|----------|---------|----------|------|
| **README_PR_3133_ANALYSIS.md** | Navigation hub, quick start | Everyone | 2 min |
...
| 2026-02-03 17:20 | Navigation guide added | README_PR_3133_ANALYSIS.md |
...
- [x] Navigation guide created (README_PR_3133_ANALYSIS.md)
...
**"How do I fix it?"**  
→ `README_PR_3133_ANALYSIS.md` § Quick Start
...
1. README_PR_3133_ANALYSIS.md (orientation)
...
*For navigation help, see: [README_PR_3133_ANALYSIS.md](../README_PR_3133_ANALYSIS.md)*
