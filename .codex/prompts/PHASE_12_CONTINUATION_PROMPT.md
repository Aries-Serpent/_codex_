...
### Documentation
- [GITHUB_COPILOT_AGENTS_PRODUCTION_SPECIFICATION.md](../../docs/agent/GITHUB_COPILOT_AGENTS_PRODUCTION_SPECIFICATION.md)
- [COGNITIVE_BRAIN_STATUS_PR_2858_UPDATE.md](../../docs/cognitive_brain/status/COGNITIVE_BRAIN_STATUS_PR_2858_UPDATE.md)
- [AI_AGENCY_POLICY_VERIFICATION.md](../../docs/admin/AI_AGENCY_POLICY_VERIFICATION.md)
