...
Example usage:
 python scripts/archive/git_patch_bundle.py bundle --repo-root . --output-dir .codex/sandbox-bundles/sandbox-transfer
 python scripts/archive/git_patch_bundle.py apply --bundle .codex/sandbox-bundles/sandbox-transfer/sandbox-git-transfer-20260829T000000Z.bundle.tar.gz --repo-root .
 python scripts/archive/git_patch_bundle.py verify --bundle .codex/sandbox-bundles/sandbox-transfer/sandbox-git-transfer-20260829T000000Z.bundle.tar.gz
"""
...
DEFAULT_BUNDLE_DIR = Path(".codex/sandbox-bundles/sandbox-transfer")
