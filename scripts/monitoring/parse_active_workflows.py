...
def generate_monitoring_report():
    ...
    print(f"Source: PR #3152 Comment #3848790670")
    print("="*80)
    ...
    if failing:
        for w in failing:
            ...
            print(f"   Action: INVESTIGATE AND FIX IMMEDIATELY")
    else:
    ...
    if in_progress:
        for w in in_progress:
            print(f"▶  {w['name']}")
            print(f"   Status: Currently running...")
            print(f"   Action: Monitor until completion")
    else:
    ...
    print(f"3. VALIDATE all workflows complete successfully before applying fixes")
    print("="*80)
