...
class CoverageAnalyzer:
    ...
    def generate_summary_report(self, analysis: dict[str, Any]) -> str:
        ...
        files = sorted(analysis["files"].items(), key=lambda x: x[1]["coverage"])
...
def main():
    ...
    analyzer = CoverageAnalyzer(target_dir=args.target, output_dir=args.output)
