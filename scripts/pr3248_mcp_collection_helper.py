...
print(f"⚠️  Note: API access limitations detected - generating template structure")
print()
...
md_lines.extend([
    ...
    "---",
    "",
    f"**Generated by:** `scripts/pr3248_mcp_collection_helper.py`",
    f"**Last Updated:** {timestamp}",
    f"**Status:** Template generated - requires API access for actual data"
])
