    ...
    "CascadeDetection": [
        {
            ...
            "expr": "cascade_wave_1_detected == 1",
            "for": "1m",
            "severity": "warning",
        ...
        },
        {
            ...
            "expr": "cascade_wave_2_detected == 1",
            "for": "1m",
            "severity": "critical",
        ...
        },
        {
            ...
            "expr": "cascade_wave_3_detected == 1",
            "for": "1m",
            "severity": "critical",
        ...
        },
        {
            ...
            "expr": "emergency_limit_triggered == 1",
            "for": "30s",
            "severity": "critical",
