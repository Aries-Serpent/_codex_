...
def generate_weekly_report(
    ...
    report.append("| Tier | Coverage | Modules |")
    report.append("|------|----------|---------|")
    ...
    if phase == "BASELINE_PHASE":
        ...
        report.append("**Next Phase:** Phase 1 (40% target) - Ready after 30 days of stability")
        report.append(f"**Prerequisite:** Coverage must remain {baseline_cov - 1.5:.2f}% - {baseline_cov + 1.5:.2f}% for {30} consecutive days\n")
    
    # Footer
    report.append("---\n")
    report.append("*Weekly report auto-generated by `scripts/ci/generate_weekly_report.py`*")
    report.append("*Reference: `.codex/COVERAGE_VALIDATION_CRITERIA.md` | `.codex/PHASE_VALIDATION_GATES.yaml`*")
