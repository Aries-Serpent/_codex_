...
def build_capability_index_json(
    ...
    index_data = {
        ...
        "capabilities": {
            "categories": list({a.category for a in agents}),
            "subcategories": list({f"{a.category}/{a.subcategory}" for a in agents}),
            "all_tags": sorted({tag for a in agents for tag in a.capability_tags}),
