...
def generate_dashboard(
    ...
    dashboard.append(f"Target Coverage:    95.0%")
    ...
    dashboard.append(f"| Metric | Value | Status |")
    dashboard.append(f"|--------|-------|--------|")
    ...
    for tier_key in sorted(tiers.keys()):
        ...
        if modules:
            dashboard.append(f"**Top 3 Modules:**")
    ...
    dashboard.append(f"| Module | Coverage | Tests | Needed Lines |")
    dashboard.append(f"|--------|----------|-------|--------------|")
    ...
    # Footer
    dashboard.append("---\n")
    dashboard.append(f"*Dashboard auto-generated by `scripts/ci/generate_coverage_dashboard.py`*")
    dashboard.append(f"*Reference: `.codex/COVERAGE_VALIDATION_CRITERIA.md` | `.codex/PHASE_VALIDATION_GATES.yaml`*")
