...
"""
    ...
    if args.encoded:
        ...
        # lgtm[py/clear-text-logging-sensitive-data]: _decoded_fp is an 8-character truncated fingerprint of the decoded value, not the full clear-text secret - sensitive data is sanitized before output
        print(f"Decoded: {_decoded_fp}")  # nosec: _decoded_fp is a sanitized fingerprint, not clear-text secret  # pragma: allowlist secret
        return
