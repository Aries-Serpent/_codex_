...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js" integrity="sha384-Wu6WSKW9XlJFLlS7yDnULhvzDn1Fn0kDuAdXXq0bXrOJKGJG6s8k9qEXVjZkQTZD" crossorigin="anonymous"></script><!-- pragma: allowlist secret -->
    <style>
        :root {{
            --bg-primary: #1a1a2e;
            --bg-secondary: #16213e;
