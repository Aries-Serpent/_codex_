...
class RollbackProcedureValidator:
    ...
    def test_rollback_syntax(self, deployment: Dict[str, Any]) -> bool:
        ...
        if test_result1['passed']:
            self.test_results['passed'] += 1
            logger.info("✅ Rollout history syntax OK")
        else:
            self.test_results['failed'] += 1
        ...
        if success2:
            self.test_results['passed'] += 1
            logger.info("✅ Rollback dry-run OK")
        else:
            self.test_results['failed'] += 1
    ...
    def test_deployment_status(self, deployment: Dict[str, Any]) -> bool:
        ...
        if success:
            self.test_results['passed'] += 1
            logger.info("✅ Deployment status check OK")
        else:
            self.test_results['failed'] += 1
    ...
    def test_pod_selection(self, deployment: Dict[str, Any]) -> bool:
        ...
        if not selector:
            logger.warning("No selector found for deployment")
            return True
    ...
    def generate_report(self, output_file: Optional[str] = None) -> str:
        ...
        report.append("**Mode:** Dry-run (no actual changes)\n\n")
