...
def generate_summary_report(inventory: dict):
    ...
    with open(report_path, "w") as f:
        ...
        # Category breakdown
        f.write("## Workflows by Category\n\n")  # nosec  # codeql[py/clear-text-storage-sensitive-data]  # nosec  # codeql[py/clear-text-storage-sensitive-data]  # nosec  # codeql[py/clear-text-logging-sensitive-data]  # pragma: allowlist secret
        by_category = defaultdict(list)
        for workflow in inventory["workflows"]:
