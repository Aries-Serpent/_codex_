            ...
            try:
                ...
                for i, line in enumerate(lines, start=1):
                    ...
                    if "todo" in line_lower and "#" in line:
                        priority = "P0" if "p0" in line_lower or "critical" in line_lower else \
                                  "P1" if "p1" in line_lower or "high" in line_lower else "P2"
                    ...
                    if "fixme" in line_lower and "#" in line:
                        priority = "P0" if "p0" in line_lower or "critical" in line_lower else \
                                  "P1" if "p1" in line_lower or "high" in line_lower else "P1"
                        message = line.split("#", 1)[1].strip()
