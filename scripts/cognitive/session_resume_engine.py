...
class SessionContext:
    ...
    def is_valid(self) -> bool:
        ...
        return (
            ...
            self.agent_state is not None and
            self.execution_progress is not None
        )
...
class SessionResumeEngine:
    ...
    def validate_and_recover(
        ...
        checkpoint_doc["_recovery_metadata"] = {
            ...
            "original_error": validation_result.errors[0].message if validation_result.errors else None,
            "degraded_mode": True,
        }
    ...
    def _run_warmup_sequence(self, context: SessionContext) -> None:
        ...
        try:
            ...
            logger.info(f"  - Progress: {completed} done, {pending} pending, current={current_task}")
    ...
    def _recover_quantum(
        ...
        recovered_doc = {
            ...
            "memory_snapshot": partial_doc.get("memory_snapshot", {
                "short_term_memory": [],
                "long_term_memory": [],
                "total_patterns": 0,
            }),
            "execution_progress": partial_doc.get("execution_progress", {
                "current_task": None,
                "completed_tasks": [],
                "pending_tasks": [],
            }),
