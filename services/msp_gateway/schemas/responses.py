...
class InferResponse(BaseModel):
    ...
    evidence: Optional[List[EvidenceTag]] = Field(default_factory=list, description="Source evidence tags")
    metadata: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Additional metadata")
...
class HealthResponse(BaseModel):
    ...
    checks: Optional[Dict[str, bool]] = Field(default_factory=dict, description="Component health checks")
