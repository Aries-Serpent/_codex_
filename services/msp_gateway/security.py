...
def legacy_hash_api_key(api_key: str) -> str:
    ...
    # lgtm[py/weak-cryptographic-algorithm]: SHA-256 used intentionally for backward compatibility with legacy stored hashes - new implementations use PBKDF2 via hash_api_key()
