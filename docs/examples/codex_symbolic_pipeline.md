...
Source: [`docs/examples/codex_symbolic_pipeline.py`](../examples/codex_symbolic_pipeline.py)
Production module: [`src/codex_ml/symbolic_pipeline.py`](../src/codex_ml/symbolic_pipeline.py)
