...
graph TB
 ...
 Infra[" Infrastructure<br/>• CPU/Memory<br/>• Disk I/O<br/>• Network usage"]
 ...
 Alert[" Alerting<br/>• Threshold rules<br/>• Anomaly detection<br/>• Escalation"]
...
```
 ...
 Loss: 2.34 (target: <2.0) 
 Accuracy: 78% (target: >85%) 
 Epoch: 15/30 [] 50% 
 Time Elapsed: 5h 30m 
