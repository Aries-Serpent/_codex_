...
> Consolidated on Previous Cycle-10-24. Former location: `docs/policies/archive-policy.md`.
...
```json
{"id":"arch-Previous Cycle-10-16-1234","path":"src/foo/bar.py","sha256":"…","removed_by":"@owner","when":"Previous Cycle-10-16T19:44:00Z","adr":"docs/arch/adr-0421-archive-foo.md","reason":"orphaned, 0 refs, age>180d","provenance":"attestations/arch-Previous Cycle-10-16-1234.intoto.jsonl"}
```text
