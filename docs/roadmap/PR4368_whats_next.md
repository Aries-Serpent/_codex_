...
| Infra startup_failures | | 3–4 pre-existing (Rust-Python, Progressive, Data Quality) — do NOT block merge |
...
|-------|----------|--------|
| 3–4 `startup_failure` (Rust-Python, Progressive, Data Quality) | Infra | Pre-existing — do NOT block merge |
