# Audit Pipeline Reference - v0.2.0
...
> - `docs/audit/` (v0.2.0 feature guides)
...
| S4 | capabilities_scored.json | Component weighting (auto-normalize) | **v0.2.0: Coverage & token-similarity** |
| S5 | gaps.json | Threshold filter (low < 0.70) | |
| S6 | capability_matrix_<ts>.md | Jinja render (template_hash embedded) | **v0.2.0: Enhanced reports** |
...
- **Backward Compatibility**: v0.2.0 fully compatible with v1.3.x
...
| Component | Formula | v0.2.0 Enhancement |
|-----------|---------|-------------------|
...
**See**: `docs/audit/Configuration_v0.2.0.md`

---

## 6. Coverage Augmentation (v0.2.0 NEW)
...
| scoring.coverage.enabled | bool | false | **v0.2.0**: Enable coverage augmentation |
| scoring.coverage.xml_patterns | list[str] | ["coverage.xml"] | **v0.2.0**: Coverage file patterns |
| scoring.dup.heuristic | string | "simple" | **v0.2.0**: "simple" or "token_similarity" |
| scoring.dup.threshold | float | 0.7 | **v0.2.0**: Jaccard similarity threshold |
...
**See**: `docs/audit/Configuration_v0.2.0.md` for full v0.2.0 options
...
| **Coverage drop** | **coverage_percent < previous** | **Exit non-zero (v0.2.0)** |
...
| **Scores decreased in v0.2.0** | **Token-similarity more accurate; review findings** |

**See**: `docs/audit/Troubleshooting_v0.2.0.md`
...
- `docs/audit/Configuration_v0.2.0.md` - Configuration options and examples
- `docs/audit/Migration_v1.3_to_v1.4.md` - Migration guide from v1.3.x
- `docs/audit/Troubleshooting_v0.2.0.md` - Common issues and solutions
- `docs/audit/API_Reference_v0.2.0.md` - Module API documentation
- `docs/audit/Integration_Examples.md` - CI/CD and tool integrations
- `docs/audit/Performance_Tuning.md` - Optimization strategies

---

## 19. Quick Start v0.2.0
...
| Type errors | Already fixed in v0.2.0; if custom code, add type ignores |
...
v0.2.0 enhances the audit pipeline with:
