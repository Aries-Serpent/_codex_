# Migration Guide: v1.3.x to v0.2.0
...
Upgrade your audit pipeline from v1.3.x to v0.2.0 to gain:
...
**None**  - v0.2.0 is fully backward compatible with v1.3.x
...
# Verify v0.2.0 is available
python scripts/space_traversal/audit_runner.py --version
# Should show v0.2.0 or confirm modules exist
```
...
# You don't need to change anything yet - v0.2.0 is backward compatible
```

## Step 4: Test v0.2.0 (Without New Features)

Run audit with your existing configuration:

```bash
# Run audit (v0.2.0 with backward compatibility)
make space-audit
 ...
 **At this point, you're running v0.2.0 with full backward compatibility**
...
```bash
# Check out previous commit (if you pulled v0.2.0)
...
- See [Troubleshooting Guide](./Troubleshooting_v0.2.0.md)
...
- See [Configuration Guide](./Configuration_v0.2.0.md)
...
**A**: No. v0.2.0 is fully backward compatible. New features are opt-in.

### Q: Will my scores change?

**A**: Not unless you enable the new features. With default settings, v0.2.0 behaves like v1.3.x.
...
### Q: Is v0.2.0 slower than v1.3.x?
...
### Q: Can I gradually roll out v0.2.0?

**A**: Yes. Recommended approach:
1. Upgrade to v0.2.0 (backward compatible)
...
- **Configuration**: See [Configuration Guide](./Configuration_v0.2.0.md)
- **Issues**: See [Troubleshooting Guide](./Troubleshooting_v0.2.0.md)
- **API**: See [API Reference](./API_Reference_v0.2.0.md)
...
v0.2.0 migration is **easy and safe**:
