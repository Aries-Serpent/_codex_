...
This guide addresses common issues when using audit pipeline v0.2.0, with a focus on new features:
...
## Issue: Scores Decreased Significantly After v0.2.0
...
**Already fixed in v0.2.0** - Files have proper type ignores
