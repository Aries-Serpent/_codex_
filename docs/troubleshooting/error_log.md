...
## Missing `pre-commit` binary (2024-09-13)
...
## `pytest` coverage argument rejected (2024-09-13)
...
## Optional dependency import explosions (2024-09-13)
...
## Training CLI missing Torch (2024-09-13)
...
## Optional dependency gate failures (2024-09-15)
...
## Torch stub lacks `torch.utils` (2024-09-23)
...
## Torch DataLoader import failures (2024-10-15)
