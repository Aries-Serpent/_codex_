...
- components.md — Improve component scores (functionality, consistency, tests, safeguards, docs).
- detectors.md — Add/fix detectors; follow contract and unit test tips.
