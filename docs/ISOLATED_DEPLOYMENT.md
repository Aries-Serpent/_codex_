...
> ️ Pre-release note: treat this as v0.2.1 pre-release deployment guidance pending P0 campaign closure (lock/profile alignment, hash-verified manifests, strict no-network bootstrap path).
