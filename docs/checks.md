...
names in [`actionlint.yaml` configuration file](./config/INDEX.md) to let actionlint know them.
...
[Usage](usage.md) | [Configuration](./config/INDEX.md) | [Go API](api.md) | [References](./reference/INDEX.md)
