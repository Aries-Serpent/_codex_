...
> Generated: Previous Cycle-09-22 22:15:51 | Author: mbaetiong
...
- Coverage gate: `pytest --cov-fail-under=3.5` enforces a baseline; on failure, a minimal fallback test run is attempted.
