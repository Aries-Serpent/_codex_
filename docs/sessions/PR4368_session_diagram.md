...
| S896 | Merge conflict + CodeQL | NameError + CodeQL + tests restored | Commit `4f10df026238` missed CHANGELOG/accountability update (Pattern 25 violation) auto-fix workflow triggered failure |
