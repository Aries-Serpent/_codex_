...
- [1) Repository Variables (`/settings/variables/actions`) ✅ ALL IMPLEMENTED](#1-repository-variables-settingsvariablesactions--all-implemented)
  ...
  - [2) Repository Secrets (`/settings/secrets/actions`)](#2-repository-secrets-settingssecretsactions)
    ...
    - [MUST-HAVE Repository Secrets (Priority: CRITICAL)](#must-have-repository-secrets-priority-critical)
    - [SHOULD-HAVE Repository Secrets (Priority: HIGH)](#should-have-repository-secrets-priority-high)
    - [MAY-HAVE Repository Secrets (Priority: OPTIONAL)](#may-have-repository-secrets-priority-optional)
    - [Secret Rotation Policy](#secret-rotation-policy)
  - [3) Environment Variables + Secrets (`Aries_Serpent_codex_`)](#3-environment-variables--secrets-aries_serpent_codex_)
    - [Create Environment (if not exists)](#create-environment-if-not-exists)
    - [Environment Variables](#environment-variables)
    - [Environment Secrets](#environment-secrets)
    - [Secret Rotation Schedule](#secret-rotation-schedule)
  - [4) Organization Variables (`/organizations/.../settings/variables/actions`)](#4-organization-variables-organizationssettingsvariablesactions)
    - [Step-by-Step Instructions](#step-by-step-instructions)
    - [Current Status](#current-status)
  - [5) Organization Secrets (`/organizations/.../settings/secrets/actions`)](#5-organization-secrets-organizationssettingssecretsactions)
    - [Step-by-Step Instructions](#step-by-step-instructions)
    - [MUST-HAVE Organization Secrets (Priority: CRITICAL)](#must-have-organization-secrets-priority-critical)
    - [SHOULD-HAVE Organization Secrets (Priority: HIGH)](#should-have-organization-secrets-priority-high)
    - [MAY-HAVE Organization Secrets (Priority: OPTIONAL)](#may-have-organization-secrets-priority-optional)
    - [Secret Rotation Policy](#secret-rotation-policy)
  - [6) Agents Variables (`/settings/variables/agents`)](#6-agents-variables-settingsvariablesagents)
    - [Step-by-Step Instructions](#step-by-step-instructions)
    - [MUST-HAVE Agent Variables (Priority: CRITICAL)](#must-have-agent-variables-priority-critical)
    - [SHOULD-HAVE Agent Variables (Priority: HIGH)](#should-have-agent-variables-priority-high)
    - [MAY-HAVE Agent Variables (Priority: OPTIONAL)](#may-have-agent-variables-priority-optional)
  - [7) Agents Secrets (`/settings/secrets/agents`)](#7-agents-secrets-settingssecretsagents)
    - [Step-by-Step Instructions](#step-by-step-instructions)
    - [MUST-HAVE Agent Secrets (Priority: CRITICAL)](#must-have-agent-secrets-priority-critical)
    - [SHOULD-HAVE Agent Secrets (Priority: HIGH)](#should-have-agent-secrets-priority-high)
    - [MAY-HAVE Agent Secrets (Priority: OPTIONAL)](#may-have-agent-secrets-priority-optional)
...
- [📊 Complete Inventory Tables](#-complete-inventory-tables)
  ...
  - [Repository Variables](#repository-variables)
    - [Maintainer Add/Update Notes — Repository Variables](#maintainer-addupdate-notes--repository-variables)
  - [Environment Secrets (Aries_Serpent_codex_ Environment)](#environment-secrets-aries_serpent_codex_-environment)
    - [Maintainer Add/Update Notes — Environment Secrets](#maintainer-addupdate-notes--environment-secrets)
