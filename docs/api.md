...
- `PopularActions` global variable is data set of popular actions' metadata collected by [the script](https://github.com/rhysd/actionlint/blob/main/scripts/generate-popular-actions).
