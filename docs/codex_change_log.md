...
| 2025-12-01T00:45:00Z | 2 | 2.2 | ok | Command: python tools/codex_gap_registry.py --audit _codex_status_update-Previous Cycle-11-27.md --change-log codex_change_log.md --errors codex_error_questions.md --out codex_gap_registry.yaml |
...
| 2025-12-01T00:45:00Z | 2 | 2.4 | ok | Command: python tools/codex_gap_registry.py --audit _codex_status_update-Previous Cycle-11-27.md --change-log codex_change_log.md --errors codex_error_questions.md --out codex_gap_registry.yaml |
...
| 2025-12-01T00:45:11Z | 6 | 6.3 | ok | Command: python tools/codex_reproducibility_bundle.py --audit _codex_status_update-Previous Cycle-11-27.md --manifest-out codex_reproducibility_manifest.json |
