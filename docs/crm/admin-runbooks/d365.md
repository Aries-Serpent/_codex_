...
Snapshots capture local Config-as-Data (for example CSVs under `configs/deployment/d365`)
...
The emitter reads `configs/deployment/d365/solution_manifest.json` and produces an unmanaged
