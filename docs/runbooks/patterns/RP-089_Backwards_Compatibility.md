# RP-089: Backwards Compatibility
...
**Problem**: Automated detection of backwards compatibility in CI workflows.
...
Backwards Compatibility failures typically result from:
...
```python
def detect_rp_089(log_text: str) -> bool:
...
```python
def analyze_rp_089(context: str) -> Dict:
    return {
        "pattern": "RP-089",
        "confidence": 0.9,
        "category": "configuration-management",
