...
**Problem**: Automated detection of blue-green deploy in CI workflows.
...
Blue-Green Deploy failures typically result from:
...
```python
def detect_rp_022(log_text: str) -> bool:
...
```python
def analyze_rp_022(context: str) -> Dict:
    return {
        "pattern": "RP-022",
        "confidence": 0.95,
        "category": "deployment-pipeline",
...
```
✅ RP-022 remediation applied
✅ Blue-Green Deploy resolved
