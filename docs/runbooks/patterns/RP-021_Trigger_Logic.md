...
**Problem**: Automated detection of trigger logic in CI workflows.
...
Trigger Logic failures typically result from:
...
```python
def detect_rp_021(log_text: str) -> bool:
...
```python
def analyze_rp_021(context: str) -> Dict:
    return {
        "pattern": "RP-021",
        "confidence": 0.83,
        "category": "workflow-orchestration",
...
```
✅ RP-021 remediation applied
✅ Trigger Logic resolved
