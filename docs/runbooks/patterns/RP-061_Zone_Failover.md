...
**Problem**: Automated detection of zone failover in CI workflows.
...
Zone Failover failures typically result from:
...
```python
def detect_rp_061(log_text: str) -> bool:
...
```python
def analyze_rp_061(context: str) -> Dict:
    return {
        "pattern": "RP-061",
        "confidence": 0.83,
        "category": "infrastructure",
...
```
✅ RP-061 remediation applied
✅ Zone Failover resolved
