...
| Python File Relocation | [`sitecustomize.py`](../../sitecustomize.py), [`conftest.py`](https://github.com/Aries-Serpent/_codex_/blob/main/conftest.py), [`tests/`](https://github.com/Aries-Serpent/_codex_/blob/main/tests) |
