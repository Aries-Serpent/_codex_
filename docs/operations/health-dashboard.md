...
| **Avg Workflow Duration** | 23.4 min | ≤25 min | ✅ | ↗️ Improving |
...
| **P99 Latency** | 456ms | ≤500ms | ✅ | ↗️ Improving |
| **Cost/Workflow** | $2.18 | ≤$2.50 | ✅ | ↗️ Improving |
| **Agent Success Rate** | 94.3% | ≥90% | ✅ | Stable |
| **Doc Freshness** | 92.4% | ≥95% | ⚠️ | Stable |
...
**Trend:** ↗️ **Improving** - Recent optimizations in parallel job execution reducing duration by ~5%.
...
**Alert Thresholds:**
- ⚠️ **Warning** if any MEDIUM or above alerts appear
...
**Trend:** ↗️ **Improving** - Down from 550ms baseline through cache optimization and query tuning.
...
**Trend:** ↗️ **Improving** - Down from $3.00 baseline through:
...
**Status:** ⚠️ **Caution** - 92.4%, slightly below 95% target. 8 documents flagged as stale.
