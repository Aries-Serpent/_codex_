...
| **developer_orchestrator.py** | 335 | **18.24%** | **-4.36%** |
...
1. **Coverage accounting** - Adding methods temporarily reduces % due to denominator increase
2. **Test activation automation** - Regex patterns need careful indentation handling
3. **API discovery** - Need to inspect actual code vs test expectations
