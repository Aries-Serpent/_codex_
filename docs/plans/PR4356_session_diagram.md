...
sequenceDiagram
 ...
 A->>A: Extend session TTL 1h12h<br/>agent-auth-delegation.yml · session-lock TTL<br/>Secrets baseline: 3 NoneFalse entries
...
is_secret=false in .secrets.baseline"]
 ...
 P2 --> INFO1["ℹ Not current HEAD
already resolved in S864+"]

 P3 --> INFO2["ℹ Resilient workflow
already in place since S154"]

 P4 --> INFO3["ℹ Different branch
not PR #4356"]

 P5 --> INFO4["ℹ Normal gating
