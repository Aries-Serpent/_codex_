...
## Table of Contents
 ...
 - [Format per item:](#format-per-item)
...
- PROMPT.Inputs: {spinor_sample, dt:0.050.02}
...
- PROMPT.FollowUps_FutureEvolution: helicitypriority mapping.
...
60) Validation matrix moduleinvariant
