...
def main():
 ...
 print("\n Invalid App ID. Skipping GitHub App configuration.")
 app_config = {}
 else:
 print("\n Skipped GitHub App configuration.")
 app_config = {}
 ...
 **app_config
 ...
 f.write("=" * 80 + "\n\n")
 f.write(" WARNING: This file contains sensitive secrets!\n")
 ...
 print(" Remember to delete this file after copying secrets to GitHub!")
