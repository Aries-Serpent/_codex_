...
> **Store the new token securely** in your password manager before proceeding.
...
> **Only do this AFTER §4 passes.** Revoking before verification will break CI.
...
**Symptom:** CI log shows ` CODEX_MASTER_KEY not available`
