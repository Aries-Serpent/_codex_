...
```mermaid
%%{init: {'accessibility': {'title': 'Flowchart showing " Foundation Era (2025-Q4)", Phase 1-5: Foundation<br/>Ingestion · Agents · RAG · CI/CD · Security'}}%%

graph TD
 subgraph Foundation[" Foundation Era (2025-Q4)"]
...
graph LR
 ...
 subgraph Architecture[" Architecture Plansets"]
