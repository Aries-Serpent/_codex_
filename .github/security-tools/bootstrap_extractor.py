...
class BootstrapExtractor:
    ...
    def extract_tool(self, tool_name: str) -> bool:
        ...
        try:
            ...
            os.chmod(output_file, 0o700 if executable else 0o644)  # codeql[py/overly-permissive-file]: 0o644 is intentionally world-readable for documentation and module files that require legitimate group/other access - executable payloads are protected with 0o700  # nosec
