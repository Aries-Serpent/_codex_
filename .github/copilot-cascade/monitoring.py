...
class CascadeMonitor:
    ...
    def record_cascade(self, results: Dict[str, Any]):
        ...
        logger.info(f"Recorded cascade: {results.get('task_id')} (success={history_entry['success']})")
    ...
    def _calculate_trends(self) -> Dict[str, Any]:
        ...
        token_change = ((recent_avg_tokens - prev_avg_tokens) / prev_avg_tokens * 100) if prev_avg_tokens > 0 else 0
        time_change = ((recent_avg_time - prev_avg_time) / prev_avg_time * 100) if prev_avg_time > 0 else 0
