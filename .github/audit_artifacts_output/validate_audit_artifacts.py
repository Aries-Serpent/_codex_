...
REQUIRED_FILES = {
    ...
    "context_index.json": {"type": "json", "min_size": 100, "schema_keys": ["files"]},
}

# Optional but recommended
OPTIONAL_FILES = ["coverage_map.json", "gaps.json", "facets.json"]
...
required_passed = sum(
    1 for r in validation_results[:total_required] if r["exists"] and not r["issues"]
)
