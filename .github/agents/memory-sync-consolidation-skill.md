...
description: Consolidate short-term memory (STM) to long-term memory (LTM) with pattern discovery, duplicate detection, retention policy application, and promotion reporting for cross-session learning.
version: 1.0.0
