...
if __name__ == "__main__":
    print("Running Reasoning Advisor Agent Tests...")  # codeql[py/clear-text-logging-sensitive-data]
    ...
    print(f"✅ Cumulative: 601 + {total} = {601 + total}/597")  # codeql[py/clear-text-logging-sensitive-data]
