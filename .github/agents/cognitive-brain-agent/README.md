...
**Agent Name**: Cognitive Brain Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for cognitive brain agent operations within the Codex ecosystem.
...
```yaml
agent_type: cognitive-brain-agent
prompt: |
...
```bash
# Via task tool
task agent_type="cognitive-brain-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cognitive-brain-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: cognitive-brain-agent
    parameters: |
