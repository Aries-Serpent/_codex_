...
**Agent Name**: UTF-8 String Safety Linter  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for utf-8 string safety linter operations within the Codex ecosystem.
...
```yaml
agent_type: utf-8-string-safety-linter
prompt: |
...
```bash
# Via task tool
task agent_type="utf-8-string-safety-linter" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate utf-8-string-safety-linter
  uses: ./.github/actions/agent-runner
  with:
    agent: utf-8-string-safety-linter
    parameters: |
