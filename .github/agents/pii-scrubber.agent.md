---
name: Pii Scrubber
description: Scrub personally identifiable information from logs, outputs, and data
...
**Agent Name**: PII Scrubber Agent
**Agent Type**: Specialized Domain
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for pii scrubber agent operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="pii-scrubber-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate pii-scrubber-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: pii-scrubber-agent
    parameters: |
