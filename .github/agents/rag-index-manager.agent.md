...
**Agent Name**: RAG Index Manager Agent
**Agent Type**: Specialized Domain
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for rag index manager agent operations within the Codex ecosystem.
...
```yaml
agent_type: rag-index-manager-agent
prompt: |
...
```bash
# Via task tool
task agent_type="rag-index-manager-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate rag-index-manager-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: rag-index-manager-agent
    parameters: |
