...
**Agent Name**: Codebase QA Walkthrough Agent - Main Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for codebase qa walkthrough agent - main prompt operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="codebase-qa-walkthrough-agent---main-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate codebase-qa-walkthrough-agent---main-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: codebase-qa-walkthrough-agent---main-prompt
    parameters: |
...
result = invoke_agent(
    agent_type="codebase-qa-walkthrough-agent---main-prompt",
