...
```yaml
agent_type: release-gate-agent-v1.0---completion-summary
prompt: |
...
```bash
# Via task tool
task agent_type="release-gate-agent-v1.0---completion-summary" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate release-gate-agent-v1.0---completion-summary
  uses: ./.github/actions/agent-runner
  with:
    agent: release-gate-agent-v1.0---completion-summary
    parameters: |
