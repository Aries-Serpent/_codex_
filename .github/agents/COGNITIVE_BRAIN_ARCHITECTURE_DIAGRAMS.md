...
gantt
    ...
    k₁ Optimization           :done, p80, 2026-01-23, 14d
...
**Agent Name**: Cognitive Brain Architecture Diagrams  
**Agent Type**: Advisory & Analysis  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for cognitive brain architecture diagrams operations within the Codex ecosystem.
...
```yaml
agent_type: cognitive-brain-architecture-diagrams
prompt: |
...
```bash
# Via task tool
task agent_type="cognitive-brain-architecture-diagrams" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cognitive-brain-architecture-diagrams
  uses: ./.github/actions/agent-runner
  with:
    agent: cognitive-brain-architecture-diagrams
    parameters: |
