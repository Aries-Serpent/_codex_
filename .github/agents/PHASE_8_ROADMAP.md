...
**Agent Name**: Phase 8 Cognitive Brain Roadmap  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for phase 8 cognitive brain roadmap operations within the Codex ecosystem.
...
```yaml
agent_type: phase-8-cognitive-brain-roadmap
prompt: |
...
```bash
# Via task tool
task agent_type="phase-8-cognitive-brain-roadmap" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-8-cognitive-brain-roadmap
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-8-cognitive-brain-roadmap
    parameters: |
