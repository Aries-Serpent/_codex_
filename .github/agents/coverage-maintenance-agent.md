...
description: DEPRECATED — use unified-coverage-agent instead. Maintains test coverage
  over time and prevents regressions.
status: DEPRECATED
deprecated: true
...
# ⚠️ DEPRECATED — Coverage-maintenance Agent
