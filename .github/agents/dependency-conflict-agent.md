...
### Purpose
This agent provides specialized functionality for dependency conflict agent operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="dependency-conflict-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate dependency-conflict-agent
