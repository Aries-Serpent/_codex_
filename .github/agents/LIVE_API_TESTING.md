...
```yaml
agent_type: live-api-testing-guide
prompt: |
...
```bash
# Via task tool
task agent_type="live-api-testing-guide" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate live-api-testing-guide
  uses: ./.github/actions/agent-runner
  with:
    agent: live-api-testing-guide
    parameters: |
