...
**Agent Name**: Project Architect Researcher Agent - Main Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for project architect researcher agent - main prompt operations within the Codex ecosystem.
...
```yaml
agent_type: project-architect-researcher-agent---main-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="project-architect-researcher-agent---main-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate project-architect-researcher-agent---main-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: project-architect-researcher-agent---main-prompt
    parameters: |
