...
**Agent Name**: Project Architect Researcher Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for project architect researcher agent operations within the Codex ecosystem.
...
```yaml
agent_type: project-architect-researcher-agent
prompt: |
...
```bash
# Via task tool
task agent_type="project-architect-researcher-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate project-architect-researcher-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: project-architect-researcher-agent
    parameters: |
