...
```yaml
agent_type: quantum-physics-inspired-resolution-plan
prompt: |
...
```bash
# Via task tool
task agent_type="quantum-physics-inspired-resolution-plan" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate quantum-physics-inspired-resolution-plan
  uses: ./.github/actions/agent-runner
  with:
    agent: quantum-physics-inspired-resolution-plan
    parameters: |
