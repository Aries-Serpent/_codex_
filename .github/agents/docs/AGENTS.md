...
```yaml
agent_type: agents.md---ai-agent-documentation
prompt: |
...
```bash
# Via task tool
task agent_type="agents.md---ai-agent-documentation" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate agents.md---ai-agent-documentation
  uses: ./.github/actions/agent-runner
  with:
    agent: agents.md---ai-agent-documentation
    parameters: |
