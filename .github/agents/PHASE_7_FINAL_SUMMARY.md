...
```yaml
agent_type: phase-7-cognitive-brain---final-implementation-summary
prompt: |
...
```bash
# Via task tool
task agent_type="phase-7-cognitive-brain---final-implementation-summary" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-7-cognitive-brain---final-implementation-summary
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-7-cognitive-brain---final-implementation-summary
    parameters: |
