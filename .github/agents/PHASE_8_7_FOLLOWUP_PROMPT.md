...
**Agent Name**: Phase_8_7_Followup_Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for phase_8_7_followup_prompt operations within the Codex ecosystem.
...
```yaml
agent_type: phase_8_7_followup_prompt
prompt: |
...
```bash
# Via task tool
task agent_type="phase_8_7_followup_prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase_8_7_followup_prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: phase_8_7_followup_prompt
    parameters: |
