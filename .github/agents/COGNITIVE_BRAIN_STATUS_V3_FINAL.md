...
### Purpose
This agent provides specialized functionality for cognitive brain status update v3.0 - phase 8.0-8.1.1 complete operations within the Codex ecosystem.
...
```yaml
agent_type: cognitive-brain-status-update-v3.0---phase-8.0-8.1.1-complete
prompt: |
...
```bash
# Via task tool
task agent_type="cognitive-brain-status-update-v3.0---phase-8.0-8.1.1-complete" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cognitive-brain-status-update-v3.0---phase-8.0-8.1.1-complete
  uses: ./.github/actions/agent-runner
  with:
    agent: cognitive-brain-status-update-v3.0---phase-8.0-8.1.1-complete
    parameters: |
