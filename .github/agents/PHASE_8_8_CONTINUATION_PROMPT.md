...
**Agent Name**: Phase 8.8+ Continuation Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for phase 8.8+ continuation prompt operations within the Codex ecosystem.
...
```yaml
agent_type: phase-8.8+-continuation-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="phase-8.8+-continuation-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-8.8+-continuation-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-8.8+-continuation-prompt
    parameters: |
