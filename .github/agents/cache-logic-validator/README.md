...
**Agent Name**: Cache Logic Validator Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for cache logic validator agent operations within the Codex ecosystem.
...
```yaml
agent_type: cache-logic-validator-agent
prompt: |
...
```bash
# Via task tool
task agent_type="cache-logic-validator-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cache-logic-validator-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: cache-logic-validator-agent
    parameters: |
