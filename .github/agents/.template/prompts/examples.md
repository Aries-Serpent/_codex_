...
### Purpose
This agent provides specialized functionality for [agent name] examples operations within the Codex ecosystem.
...
```yaml
agent_type: [agent-name]-examples
prompt: |
...
```bash
# Via task tool
task agent_type="[agent-name]-examples" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate [agent-name]-examples
