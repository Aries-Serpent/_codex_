...
### Purpose
This agent provides specialized functionality for [agent name] operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="[agent-name]" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate [agent-name]
