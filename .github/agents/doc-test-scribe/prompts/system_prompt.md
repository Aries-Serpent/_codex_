...
**Agent Name**: Doc-Test-Scribe Agent System Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for doc-test-scribe agent system prompt operations within the Codex ecosystem.
...
```yaml
agent_type: doc-test-scribe-agent-system-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="doc-test-scribe-agent-system-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate doc-test-scribe-agent-system-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: doc-test-scribe-agent-system-prompt
    parameters: |
