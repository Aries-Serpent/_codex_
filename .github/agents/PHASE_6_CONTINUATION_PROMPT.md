...
```yaml
agent_type: phase-6-continuation-prompt:-implement-remaining-8-agents
prompt: |
...
```bash
# Via task tool
task agent_type="phase-6-continuation-prompt:-implement-remaining-8-agents" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-6-continuation-prompt:-implement-remaining-8-agents
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-6-continuation-prompt:-implement-remaining-8-agents
    parameters: |
