...
**Agent Name**: GitHub App Setup Guide  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for github app setup guide operations within the Codex ecosystem.
...
```yaml
agent_type: github-app-setup-guide
prompt: |
...
```bash
# Via task tool
task agent_type="github-app-setup-guide" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate github-app-setup-guide
  uses: ./.github/actions/agent-runner
  with:
    agent: github-app-setup-guide
    parameters: |
