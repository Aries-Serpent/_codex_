...
description: Monitor IPC bridge security and detect unauthorized access or security
  policy violations
...
**Agent Name**: Bridge Security Monitor Agent
**Agent Type**: Monitoring & Validation
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for bridge security monitor agent operations within the Codex ecosystem.
...
```yaml
agent_type: bridge-security-monitor-agent
prompt: |
...
```bash
# Via task tool
task agent_type="bridge-security-monitor-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate bridge-security-monitor-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: bridge-security-monitor-agent
    parameters: |
