...
```yaml
agent_type: cognitive-brain-status-update-&-complete-roadmap
prompt: |
...
```bash
# Via task tool
task agent_type="cognitive-brain-status-update-&-complete-roadmap" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cognitive-brain-status-update-&-complete-roadmap
  uses: ./.github/actions/agent-runner
  with:
    agent: cognitive-brain-status-update-&-complete-roadmap
    parameters: |
