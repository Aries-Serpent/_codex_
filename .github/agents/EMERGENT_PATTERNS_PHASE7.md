...
```bash
# Via task tool
task agent_type="phase-7-emergent-patterns-&-autonomous-automation-insights" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-7-emergent-patterns-&-autonomous-automation-insights
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-7-emergent-patterns-&-autonomous-automation-insights
    parameters: |
...
result = invoke_agent(
    agent_type="phase-7-emergent-patterns-&-autonomous-automation-insights",
