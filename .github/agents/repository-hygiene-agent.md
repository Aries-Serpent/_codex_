...
**Agent Name**: Repository Hygiene Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for repository hygiene agent operations within the Codex ecosystem.
...
```yaml
agent_type: repository-hygiene-agent
prompt: |
...
```bash
# Via task tool
task agent_type="repository-hygiene-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate repository-hygiene-agent
