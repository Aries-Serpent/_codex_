...
description: DEPRECATED — use unified-coverage-agent instead. Drives the incremental
  coverage threshold roadmap and tracks progress.
status: DEPRECATED
deprecated: true
...
# ⚠️ DEPRECATED — Coverage-roadmap Agent
