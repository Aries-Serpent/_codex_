...
**Agent Name**: Complete Implementation Planset  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for complete implementation planset operations within the Codex ecosystem.
...
```yaml
agent_type: complete-implementation-planset
prompt: |
...
```bash
# Via task tool
task agent_type="complete-implementation-planset" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate complete-implementation-planset
  uses: ./.github/actions/agent-runner
  with:
    agent: complete-implementation-planset
    parameters: |
