...
**Agent Name**: Workflow Manager Design Document  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for workflow manager design document operations within the Codex ecosystem.
...
```yaml
agent_type: workflow-manager-design-document
prompt: |
...
```bash
# Via task tool
task agent_type="workflow-manager-design-document" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate workflow-manager-design-document
  uses: ./.github/actions/agent-runner
  with:
    agent: workflow-manager-design-document
    parameters: |
