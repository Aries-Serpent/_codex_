...
### Purpose
This agent provides specialized functionality for integration manager design document operations within the Codex ecosystem.
...
```yaml
agent_type: integration-manager-design-document
prompt: |
...
```bash
# Via task tool
task agent_type="integration-manager-design-document" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate integration-manager-design-document
  uses: ./.github/actions/agent-runner
  with:
    agent: integration-manager-design-document
    parameters: |
