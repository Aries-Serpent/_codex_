...
**Agent Name**: AST Analysis Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for ast analysis agent operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="ast-analysis-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate ast-analysis-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: ast-analysis-agent
    parameters: |
