...
**Agent Name**: Changelog - Rust Error Validator Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for changelog - rust error validator agent operations within the Codex ecosystem.
...
```yaml
agent_type: changelog---rust-error-validator-agent
prompt: |
...
```bash
# Via task tool
task agent_type="changelog---rust-error-validator-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate changelog---rust-error-validator-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: changelog---rust-error-validator-agent
    parameters: |
