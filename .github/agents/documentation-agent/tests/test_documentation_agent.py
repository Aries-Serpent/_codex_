...
if __name__ == "__main__":
    print("Running Documentation Agent Tests...")  # codeql[py/clear-text-logging-sensitive-data]
    ...
    print(f"\n✅ Total tests: {total_tests}")  # codeql[py/clear-text-logging-sensitive-data]
