...
**Agent Name**: Coverage Gapfill Agent
**Agent Type**: Specialized Domain
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for coverage gapfill agent operations within the Codex ecosystem.
...
```bash
# Via task tool
task agent_type="coverage-gapfill-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate coverage-gapfill-agent
