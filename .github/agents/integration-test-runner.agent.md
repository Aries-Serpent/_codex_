...
description: Run integration tests across services, validate end-to-end workflows,
  and report coverage results
...
**Agent Name**: Integration Test Runner Agent
**Agent Type**: Specialized Domain
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for integration test runner agent operations within the Codex ecosystem.
...
```yaml
agent_type: integration-test-runner-agent
prompt: |
...
```bash
# Via task tool
task agent_type="integration-test-runner-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate integration-test-runner-agent
