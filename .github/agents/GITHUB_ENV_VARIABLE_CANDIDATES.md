...
**Agent Name**: GitHub Environment Variable Candidates - 48KB Base64 Analysis  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for github environment variable candidates - 48kb base64 analysis operations within the Codex ecosystem.
...
```yaml
agent_type: github-environment-variable-candidates---48kb-base64-analysis
prompt: |
...
```bash
# Via task tool
task agent_type="github-environment-variable-candidates---48kb-base64-analysis" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate github-environment-variable-candidates---48kb-base64-analysis
  uses: ./.github/actions/agent-runner
  with:
    agent: github-environment-variable-candidates---48kb-base64-analysis
    parameters: |
