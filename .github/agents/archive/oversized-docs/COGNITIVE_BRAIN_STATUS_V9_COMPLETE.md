...
```mermaid
graph LR
    A[Phase 8.8<br/>85.0/100] --> B[Phase 8.9<br/>91.8/100]
...
```
┌─────────────────────────────────────────────────────────────┐
│ COGNITIVE BRAIN DASHBOARD v9.0 - 2026-01-23               │
├─────────────────────────────────────────────────────────────┤
│                                                              │
...
**Agent Name**: Cognitive Brain Status V9 - COMPLETE  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for cognitive brain status v9 - complete operations within the Codex ecosystem.
...
```yaml
agent_type: cognitive-brain-status-v9---complete
prompt: |
...
```bash
# Via task tool
task agent_type="cognitive-brain-status-v9---complete" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate cognitive-brain-status-v9---complete
  uses: ./.github/actions/agent-runner
  with:
    agent: cognitive-brain-status-v9---complete
    parameters: |
