...
```python
{
    ...
    "report_path": "/tmp/compliance-audit-2026-01-23.pdf",
...
```yaml
agent_type: compliance-checker-agent-implementation-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="compliance-checker-agent-implementation-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate compliance-checker-agent-implementation-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: compliance-checker-agent-implementation-prompt
    parameters: |
