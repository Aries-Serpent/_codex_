...
**Agent Name**: Batch Analysis Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for batch analysis prompt operations within the Codex ecosystem.
...
```yaml
agent_type: batch-analysis-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="batch-analysis-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate batch-analysis-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: batch-analysis-prompt
    parameters: |
