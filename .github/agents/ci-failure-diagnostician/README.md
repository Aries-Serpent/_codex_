...
**Agent Name**: CI Failure Diagnostician Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for ci failure diagnostician agent operations within the Codex ecosystem.
...
```yaml
agent_type: ci-failure-diagnostician-agent
prompt: |
...
```bash
# Via task tool
task agent_type="ci-failure-diagnostician-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate ci-failure-diagnostician-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: ci-failure-diagnostician-agent
    parameters: |
