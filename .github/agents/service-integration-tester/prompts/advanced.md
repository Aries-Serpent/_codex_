...
**Agent Name**: Service Integration Tester - Advanced Patterns  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for service integration tester - advanced patterns operations within the Codex ecosystem.
...
```yaml
agent_type: service-integration-tester---advanced-patterns
prompt: |
...
```bash
# Via task tool
task agent_type="service-integration-tester---advanced-patterns" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate service-integration-tester---advanced-patterns
  uses: ./.github/actions/agent-runner
  with:
    agent: service-integration-tester---advanced-patterns
    parameters: |
