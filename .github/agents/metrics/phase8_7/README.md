...
**Agent Name**: Phase 8.7 Metrics Directory  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for phase 8.7 metrics directory operations within the Codex ecosystem.
...
```yaml
agent_type: phase-8.7-metrics-directory
prompt: |
...
```bash
# Via task tool
task agent_type="phase-8.7-metrics-directory" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate phase-8.7-metrics-directory
  uses: ./.github/actions/agent-runner
  with:
    agent: phase-8.7-metrics-directory
    parameters: |
