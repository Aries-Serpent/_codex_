...
### Purpose
This agent provides specialized functionality for cognitive brain custom copilot agents specification operations within the Codex ecosystem.
...
```yaml
agent_type: cognitive-brain-custom-copilot-agents-specification
prompt: |
