...
**Agent Name**: Semantic Search Agent
**Agent Type**: Specialized Domain
**Energy Level**: 3/5
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for semantic search agent operations within the Codex ecosystem.
...
```yaml
agent_type: semantic-search-agent
prompt: |
...
```bash
# Via task tool
task agent_type="semantic-search-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate semantic-search-agent
