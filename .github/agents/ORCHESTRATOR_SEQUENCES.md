...
completed: 2025-12-31T22:30:00Z
...
**Agent Name**: Agent Orchestrator Sequences - Aries-Serpent/_codex_  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for agent orchestrator sequences - aries-serpent/_codex_ operations within the Codex ecosystem.
...
```yaml
agent_type: agent-orchestrator-sequences---aries-serpent/_codex_
prompt: |
...
```bash
# Via task tool
task agent_type="agent-orchestrator-sequences---aries-serpent/_codex_" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate agent-orchestrator-sequences---aries-serpent/_codex_
  uses: ./.github/actions/agent-runner
  with:
    agent: agent-orchestrator-sequences---aries-serpent/_codex_
    parameters: |
