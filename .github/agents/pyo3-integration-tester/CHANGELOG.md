...
**Agent Name**: Changelog - PyO3 Integration Tester Agent  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for changelog - pyo3 integration tester agent operations within the Codex ecosystem.
...
```yaml
agent_type: changelog---pyo3-integration-tester-agent
prompt: |
...
```bash
# Via task tool
task agent_type="changelog---pyo3-integration-tester-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate changelog---pyo3-integration-tester-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: changelog---pyo3-integration-tester-agent
    parameters: |
