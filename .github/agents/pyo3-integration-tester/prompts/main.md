...
**Agent Name**: PyO3 Integration Tester Agent - Main Prompt  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for pyo3 integration tester agent - main prompt operations within the Codex ecosystem.
...
```yaml
agent_type: pyo3-integration-tester-agent---main-prompt
prompt: |
...
```bash
# Via task tool
task agent_type="pyo3-integration-tester-agent---main-prompt" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate pyo3-integration-tester-agent---main-prompt
  uses: ./.github/actions/agent-runner
  with:
    agent: pyo3-integration-tester-agent---main-prompt
    parameters: |
