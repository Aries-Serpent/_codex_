...
d365-architect audit-trail --since 2026-01-23
...
**Agent Name**: Dynamics 365 & Power Platform Architect Agent - Development Planset  
**Agent Type**: Specialized Domain  
**Energy Level**: 3/5  
**Operational Status**: ✅ Active

### Purpose
This agent provides specialized functionality for dynamics 365 & power platform architect agent - development planset operations within the Codex ecosystem.
...
```yaml
agent_type: dynamics-365-&-power-platform-architect-agent---development-planset
prompt: |
...
```bash
# Via task tool
task agent_type="dynamics-365-&-power-platform-architect-agent---development-planset" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate dynamics-365-&-power-platform-architect-agent---development-planset
  uses: ./.github/actions/agent-runner
  with:
    agent: dynamics-365-&-power-platform-architect-agent---development-planset
    parameters: |
