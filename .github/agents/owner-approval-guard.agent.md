...
### Purpose
This agent provides specialized functionality for owner approval guard agent operations within the Codex ecosystem.
...
```yaml
agent_type: owner-approval-guard-agent
prompt: |
...
```bash
# Via task tool
task agent_type="owner-approval-guard-agent" description="<description>" prompt="<prompt>"
```

### GitHub Actions Trigger

```yaml
- name: Activate owner-approval-guard-agent
  uses: ./.github/actions/agent-runner
  with:
    agent: owner-approval-guard-agent
    parameters: |
