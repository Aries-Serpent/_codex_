...
### Completed Work
- [`86f509ce`] Initial plan (copilot-swe-agent[bot], 2026-02-24)
- [`5318cf22`] Merge pull request #3359 from Aries-Serpent/copilot/sub-pr-3248 (Statix, 2026-02-24)
- [`5265552d`] S85: Fix 7 Resilient Suite test failures + hotfix post-merge plan (copilot-swe-agent[bot], 2026-02-24)
...
**When you see `@copilot continue` in PR #3360:**

1. Load this prompt from `.github/copilot-prompts/active/PR-3360-followup.md`
