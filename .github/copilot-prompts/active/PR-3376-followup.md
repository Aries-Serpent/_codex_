...
### Completed Work
- [`69a255c4`] Initial plan (copilot-swe-agent[bot], 2026-02-26)
- [`dbaa9f70`] Merge pull request #3375 from Aries-Serpent/copilot/scrape-code-scanning-alerts (Statix, 2026-02-26)
- [`670118dc`] docs: add HOTFIX follow-up prompt for 3 pre-existing post-PR3375 CI failures (Art_RAG, CodeQL configs, cognitive_brain API + training assertions) (copilot-swe-agent[bot], 2026-02-26)
...
**When you see `@copilot continue` in PR #3376:**

1. Load this prompt from `.github/copilot-prompts/active/PR-3376-followup.md`
