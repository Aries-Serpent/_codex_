...
- [`9672a3d2`] fix(ci): convert zendesk imports to relative - resolve ImportError (copilot-swe-agent[bot], 2024-12-30)
- [`1cee45bf`] Initial plan (copilot-swe-agent[bot], 2024-12-30)
...
**When you see `@copilot continue` in PR #2665:**

1. Load this prompt from `.github/copilot-prompts/active/PR-2665-followup.md`
...
**Last Updated**: 2024-12-30 03:07:57
