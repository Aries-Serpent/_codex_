...
### Completed Work
- [`a71907d7`] Merge branch '0D_base_' into copilot/investigate-coherence-issue (Statix, 2026-02-19)
- [`ebd304b8`] Merge branch 'main' into 0D_base_ (Statix, 2026-02-19)
...
**When you see `@copilot continue` in PR #3333:**

1. Load this prompt from `.github/copilot-prompts/active/PR-3333-followup.md`
