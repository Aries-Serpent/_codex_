...
class QuantumInspiredGameEngine:
    ...
    def _apply_entanglement(self, strength: float) -> None:
        ...
        # Interpolate
        self.game_state.joint_wavefunction = (
            (1 - strength) * psi_product + 
            strength * psi_entangled
        )
...
class BlueRedTeamSimulator:
    ...
    def __init__(
        ...
        self.classical_engine = ClassicalGameEngine(
            blue_strategies, red_strategies,
    ...
    def evaluate_hypothesis(
        ...
        if blue_strategy_weights is not None:
            ...
            self.quantum_engine.blue_state.wavefunction = np.sqrt(blue_strategy_weights / np.sum(blue_strategy_weights))
        ...
        if red_strategy_weights is not None:
            ...
            self.quantum_engine.red_state.wavefunction = np.sqrt(red_strategy_weights / np.sum(red_strategy_weights))
