...
from .duplication import DuplicationRatio, DuplicateBlock
...
class MetricStorage:
        ...
        data = {
            ...
            "summary": {
                ...
                "avg_block_size": (
                    ...
                    if ratio.duplicate_blocks else 0
                ),
            }
        }
    ...
    def load_latest(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            metric_id, timestamp, commit_sha, ratio, total_lines, \
                duplicate_lines, files_scanned, files_with_duplicates = row
