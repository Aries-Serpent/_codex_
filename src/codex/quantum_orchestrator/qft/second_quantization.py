    ...
    def batch_spawn(
        ...
        for i in range(count):
            ...
            new_task = TaskState(
                ...
                rest_mass=template.rest_mass,
                deadline=template.deadline,
                dependencies=template.dependencies.copy() if hasattr(template, 'dependencies') else [],
                required_resources=template.required_resources.copy() if hasattr(template, 'required_resources') else {},
            )
