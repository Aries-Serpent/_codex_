...
class DashboardGenerator:
    ...
    def _generate_forecast_chart_data(
        ...
        dates = [datetime.now() + timedelta(days=i) for i in range(len(full_forecast))]
    ...
    def generate_dashboard(
        ...
        # Add alert panel
        if alerts:
            dashboard["panels"].append(self._generate_bottleneck_alert_panel(alerts))

        # Add recommendation panel
        if recommendations:
            dashboard["panels"].append(self._generate_recommendation_panel(recommendations))
