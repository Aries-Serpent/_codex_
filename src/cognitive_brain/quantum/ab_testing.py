...
class ABTestFramework:
    ...
    def get_variant_metrics(
        ...
        for metric in metrics:
            if (metric.metadata.get('experiment_id') == experiment_id and
                metric.metadata.get('variant') == variant.value and
                metric.metric_name == config.success_metric):
    ...
    def get_variant_distribution(self, experiment_id: str, n_samples: int = 1000) -> Dict[Variant, int]:
        """
