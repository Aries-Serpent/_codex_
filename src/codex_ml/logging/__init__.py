...
except (IOError, OSError, ModuleNotFoundError, ImportError):  # pragma: no cover - optional mlflow dependency
    PARAMS_SCHEMA_URI: str = ""  # type: ignore[no-redef]
    METRICS_SCHEMA_URI: str = ""  # type: ignore[no-redef]
