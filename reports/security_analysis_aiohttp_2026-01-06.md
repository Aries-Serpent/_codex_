...
All 8 Dependabot security alerts for aiohttp are **ALREADY RESOLVED** in the current codebase. The repository uses aiohttp version 3.13.3 (released January 3, 2026), which contains patches for all reported vulnerabilities. The alerts appear to be stale or were created before the dependency was updated.
