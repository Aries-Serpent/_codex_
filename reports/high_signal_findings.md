...
2. **Telemetry hardening landed.** Training configuration now exposes `log_system_metrics` and a resilient collector, closing the observability gap flagged in the Phase 10 status update.【F:reports/_codex_status_update-2025-10-05.md†L57-L57】【F:src/codex_ml/training/__init__.py†L90-L156】
