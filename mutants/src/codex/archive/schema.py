...
def x_get_bundle__mutmut_orig(name: str) -> SchemaBundle:
...
def x_get_bundle__mutmut_1(name: str) -> SchemaBundle:
    """Return the schema bundle for *name* (case insensitive)."""
...
def x_get_bundle__mutmut_2(name: str) -> SchemaBundle:
    """Return the schema bundle for *name* (case insensitive)."""
...
def x_get_bundle__mutmut_3(name: str) -> SchemaBundle:
    """Return the schema bundle for *name* (case insensitive)."""
...
def x_get_bundle__mutmut_4(name: str) -> SchemaBundle:
    """Return the schema bundle for *name* (case insensitive)."""
...
x_get_bundle__mutmut_mutants : ClassVar[MutantDict] = {
'x_get_bundle__mutmut_1': x_get_bundle__mutmut_1, 
    'x_get_bundle__mutmut_2': x_get_bundle__mutmut_2, 
    'x_get_bundle__mutmut_3': x_get_bundle__mutmut_3, 
    'x_get_bundle__mutmut_4': x_get_bundle__mutmut_4
}

def get_bundle(*args, **kwargs):
    result = _mutmut_trampoline(x_get_bundle__mutmut_orig, x_get_bundle__mutmut_mutants, args, kwargs)
    return result 

get_bundle.__signature__ = _mutmut_signature(x_get_bundle__mutmut_orig)
x_get_bundle__mutmut_orig.__name__ = 'x_get_bundle'


def x_statements_for__mutmut_orig(name: str) -> Iterable[str]:
...
def x_statements_for__mutmut_1(name: str) -> Iterable[str]:
    """Yield DDL statements for *name*."""
...
def x_statements_for__mutmut_2(name: str) -> Iterable[str]:
    """Yield DDL statements for *name*."""

    bundle = get_bundle(None)
    return bundle.statements

x_statements_for__mutmut_mutants : ClassVar[MutantDict] = {
'x_statements_for__mutmut_1': x_statements_for__mutmut_1, 
    'x_statements_for__mutmut_2': x_statements_for__mutmut_2
}

def statements_for(*args, **kwargs):
    result = _mutmut_trampoline(x_statements_for__mutmut_orig, x_statements_for__mutmut_mutants, args, kwargs)
    return result 

statements_for.__signature__ = _mutmut_signature(x_statements_for__mutmut_orig)
x_statements_for__mutmut_orig.__name__ = 'x_statements_for'
