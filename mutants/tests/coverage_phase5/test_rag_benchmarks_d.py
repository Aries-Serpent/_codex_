...
def test_benchmark_fixture_3_init():
    """Test benchmark fixture initialization."""
    fixture = BenchmarkFixture("bench3")
    assert fixture.name == "bench3", "name is not valid"


def test_benchmark_fixture_3_record():
...
def test_benchmark_fixture_3_retrieve():
...
def test_benchmark_fixture_3_missing():
