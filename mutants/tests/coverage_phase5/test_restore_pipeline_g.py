"""Test restore pipeline module 6."""
...
async def test_restore_pipeline_6_init():
    """Test restore pipeline initialization."""
    pipeline = RestorePipeline("disaster_recovery_6")
    assert pipeline.name == "disaster_recovery_6", "name is not valid"


@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_restore_pipeline_6_discover():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_restore_pipeline_6_validate():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_restore_pipeline_6_restore():
