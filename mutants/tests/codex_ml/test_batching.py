...
class TestPerformanceMetrics:
    ...
    def test_record_request(self):
        ...
        assert metrics.total_latency == 0.45
    ...
    def test_record_batch(self):
        ...
        assert metrics.get_average_batch_size() == 11.0  # (10+15+8)/3
    ...
    def test_average_latency(self):
        ...
        assert metrics.get_average_latency() == 0.2  # (0.1+0.2+0.3)/3
    ...
    def test_to_dict(self):
        ...
        assert "batch_count" in metrics_dict
        ...
        assert metrics_dict["batch_count"] == 1
...
class TestBatchingMiddleware:
    ...
    async def test_initialization(self):
        ...
        assert middleware.max_batch_size == 10
        assert middleware.max_wait_time == 0.1
        assert len(middleware.batch_queue) == 0
    ...
    async def test_batch_on_size(self):
        ...
        assert middleware.metrics.batch_count == 1
        assert middleware.metrics.request_count == 3
    ...
    async def test_batch_on_timeout(self):
        ...
        assert results == [2, 4]
        assert middleware.metrics.batch_count == 1
        assert middleware.metrics.request_count == 2
    ...
    async def test_multiple_batches(self):
        ...
        assert middleware.metrics.batch_count >= 2  # At least 2 batches
        assert middleware.metrics.request_count == 5
    ...
    async def test_metrics_tracking(self):
        ...
        assert metrics["average_batch_size"] == 3.0
