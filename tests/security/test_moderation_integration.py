...
def _rejected_decision(stage: str = "input") -> ModerationDecision:
...
def _accepted_decision(stage: str = "input") -> ModerationDecision:
...
class TestPredictEndpointModeration:
