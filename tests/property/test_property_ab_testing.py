"""Property-based tests for the A/B testing framework (Gap 41).

Verifies the mathematical and logical invariants of ``run_ab_test`` and
``ABTestResult`` using Hypothesis.
"""
...
# ---------------------------------------------------------------------------
# Effect size property
# ---------------------------------------------------------------------------


class TestEffectSizeProperty:
    """effect_size must be a finite float (no NaN/infinity from valid inputs)."""
