...
class TestModelServing:
    ...
    def test_model_load_caching(self):
        ...
        assert model_cache[model_id]["weights"] == "loaded"
    ...
    def test_model_quantization_impact(self):
        ...
        assert int8_size < full_precision_size
        assert inference_speedup > 1.0
