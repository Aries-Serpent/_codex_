...
def sample_ndjson():
    ...
    docs = [
        {"id": "doc1", "content": "Machine learning is a subset of AI.", "metadata": {"topic": "ml"}},
        {"id": "doc2", "content": "Natural language processing works with text.", "metadata": {"topic": "nlp"}},
        {"id": "doc3", "content": "Deep learning uses neural networks.", "metadata": {"topic": "dl"}},
    ]
