...
from codex.archive.cli import (
    _batch_progress_logger, # pragma: allowlist secret # pragma: allowlist secret
    _load_config,
    _parse_metadata,
    _resolve_commit,
    _service,
...
class TestParseMetadata:
    ...
    def test_parse_metadata_multipart_key(self):
        ...
        assert result["org.project.key"] == "value"
...
class TestService:
    ...
    def test_service_apply_schema_true(self, mock_service_class, mock_load_config):
        ...
        assert call_kwargs.get("apply_schema") is True
...
class TestMetadataEdgeCases:
    ...
    def test_parse_metadata_tab_in_value(self):
        ...
        assert result["tab"] == "value\\twith\\ttabs"
