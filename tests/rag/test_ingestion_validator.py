...
class TestDocumentFormat:
    ...
    def test_from_extension_csv(self):
        assert DocumentFormat.from_extension(".csv") == DocumentFormat.CSV

    def test_from_extension_xml(self):
        assert DocumentFormat.from_extension(".xml") == DocumentFormat.XML
    ...
    def test_from_mime_yaml(self):
        assert DocumentFormat.from_mime_type("application/x-yaml") == DocumentFormat.YAML
        assert DocumentFormat.from_mime_type("text/yaml") == DocumentFormat.YAML

    def test_from_mime_csv(self):
        assert DocumentFormat.from_mime_type("text/csv") == DocumentFormat.CSV

    def test_from_mime_xml(self):
        assert DocumentFormat.from_mime_type("application/xml") == DocumentFormat.XML
        assert DocumentFormat.from_mime_type("text/xml") == DocumentFormat.XML
...
class TestDocumentValidator:
    ...
    def test_validate_text_too_long(self):
        ...
        assert any("too long" in e.lower() or "maximum" in e.lower() for e in result.errors)
    ...
    def test_validate_text_word_count(self):
        ...
        assert result.metadata.get("word_count") == 3
    ...
    def test_no_malicious_check_when_disabled(self):
        ...
        assert len(malicious_warnings) == 0
