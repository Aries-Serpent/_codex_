...
class TestCalculateBackoff:
    """Test backoff calculation behaviour."""
    ...
    def test_max_delay_cap(self) -> None:
        delay = calculate_backoff(10, initial_delay=1.0, max_delay=32.0, jitter=False)
        assert delay == 32.0
...
class TestRetryTiming:
    ...
    def test_backoff_delays_execution(self) -> None:
        ...
        config = RetryConfig(max_attempts=3, initial_delay=0.05, backoff_factor=2.0, jitter=False)
