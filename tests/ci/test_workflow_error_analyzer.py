...
class TestErrorPatternDetection:
    ...
    def test_detect_import_error_module_not_found(self):
        ...
        assert "import_error" in result.errors_by_type
        assert result.errors_by_type["import_error"][0].severity == "high"
    ...
    def test_detect_import_error_name_error(self):
        ...
        assert "import_error" in result.errors_by_type
        assert "json" in result.errors_by_type["import_error"][0].match
    ...
    def test_detect_syntax_error(self):
        ...
        assert "syntax_error" in result.errors_by_type
        assert result.errors_by_severity["high"] > 0
    ...
    def test_detect_test_failure(self):
        ...
        assert "test_failure" in result.errors_by_type
        assert result.errors_by_category["testing"] > 0
    ...
    def test_detect_timeout_error(self):
        ...
        assert "timeout_error" in result.errors_by_type
        assert result.errors_by_category["performance"] > 0
    ...
    def test_detect_permission_error(self):
        ...
        assert "permission_error" in result.errors_by_type
        assert result.errors_by_severity["high"] > 0
    ...
    def test_detect_dependency_conflict(self):
        ...
        assert "dependency_conflict" in result.errors_by_type
        assert result.errors_by_category["dependency"] > 0
    ...
    def test_detect_type_error(self):
        ...
        assert "type_error" in result.errors_by_type
    ...
    def test_detect_file_not_found(self):
        ...
        assert "file_not_found" in result.errors_by_type
    ...
    def test_detect_network_error(self):
        ...
        assert "network_error" in result.errors_by_type
        assert result.errors_by_severity["low"] > 0
    ...
    def test_detect_memory_error(self):
        ...
        assert "memory_error" in result.errors_by_type
        assert result.errors_by_severity["high"] > 0
...
class TestMultipleErrorDetection:
    ...
    def test_detect_multiple_same_type(self):
        ...
        assert len(result.errors_by_type["import_error"]) == 3
    ...
    def test_error_line_numbers(self):
        ...
        assert result.errors_by_type["syntax_error"][0].line_number == 3
...
class TestCategoryClassification:
    ...
    def test_dependency_category(self):
        ...
        assert "dependency" in result.errors_by_category
    ...
    def test_code_quality_category(self):
        ...
        assert "code_quality" in result.errors_by_category
    ...
    def test_testing_category(self):
        ...
        assert "testing" in result.errors_by_category
    ...
    def test_performance_category(self):
        ...
        assert "performance" in result.errors_by_category
...
class TestAnalysisResult:
    ...
    def test_to_dict(self):
        ...
        assert d["errors_by_severity"]["high"] == 2
        assert "Fix dependencies" in d["recommendations"]
...
class TestEdgeCases:
    ...
    def test_empty_log(self):
        ...
        assert result.total_errors == 0
        assert len(result.errors_by_type) == 0
    ...
    def test_very_long_line(self):
        ...
        assert len(result.errors_by_type["import_error"][0].context) <= 200
