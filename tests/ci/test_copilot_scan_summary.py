...
class TestParseScanSummaryCommand:
    ...
    def test_basic_scan_summary_command(self):
        ...
        assert result.command == 'scan-summary', "Result must not be empty"
        assert result.query_type is None, "Result must not be empty"
        assert result.value is None, "Result must not be empty"
        assert result.scope is None, "Result must not be empty"
    ...
    def test_cwe_filter(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'cwe', "Result must not be empty"
        assert result.value == 'CWE-79', "Result must not be empty"
    ...
    def test_cwe_filter_lowercase(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'cwe', "Result must not be empty"
        assert result.value == 'cwe-22', "Result must not be empty"
    ...
    def test_severity_filter_by_name(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'severity', "Result must not be empty"
        assert result.value == 'CRITICAL', "Result must not be empty"
    ...
    def test_severity_filter_by_name_mixed_case(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'severity', "Result must not be empty"
        assert result.value == 'HIGH', "Result must not be empty"
    ...
    def test_severity_filter_explicit(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'severity', "Result must not be empty"
        assert result.value == 'MEDIUM', "Result must not be empty"
    ...
    def test_file_scope(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.scope == 'src/cli.py', "Result must not be empty"
    ...
    def test_file_scope_directory(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.scope == 'src/', "Result must not be empty"
    ...
    def test_package_filter(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.query_type == 'package', "Result must not be empty"
        assert result.value == 'numpy', "Result must not be empty"
    ...
    def test_combined_filters_cwe_and_file(self):
        ...
        assert result.query_type == 'cwe', "Result must not be empty"
        assert result.value == 'CWE-79', "Result must not be empty"
        assert result.scope == 'src/cli', "Result must not be empty"
    ...
    def test_combined_filters_severity_and_file(self):
        ...
        assert result.query_type == 'severity', "Result must not be empty"
        assert result.value == 'CRITICAL', "Result must not be empty"
        assert result.scope == 'src/cognitive_brain', "Result must not be empty"
    ...
    def test_file_path_with_spaces(self):
        ...
        assert result is not None, "result must be initialized"
        assert result.scope == 'src/path/to/module', "Result must not be empty"
...
class TestGenerateScanSummaryResponse:
    ...
    def test_empty_findings(self):
        ...
        assert "✅ No findings matched" in response, "Response must not be empty"
        assert "Good news" in response, "Response must not be empty"
    ...
    def test_single_finding(self):
        ...
        assert "🔍 Security Scan Summary" in response, "Response must not be empty"
        assert "CRITICAL" in response, "Response must not be empty"
        assert "CWE-89" in response, "Response must not be empty"
        assert "SQL Injection" in response, "Response must not be empty"
        assert "src/db.py" in response, "Response must not be empty"
        assert "CodeQL" in response, "Response must not be empty"
    ...
    def test_multiple_findings_by_severity(self):
        ...
        assert "| Severity | Count | Status |" in response, "Response must not be empty"
        assert "CRITICAL | 1 |" in response, "Response must not be empty"
        assert "HIGH | 1 |" in response, "Response must not be empty"
        assert "MEDIUM | 1 |" in response, "Response must not be empty"
    ...
    def test_response_includes_summary_table(self):
        ...
        assert "| Severity | Count | Status |" in response, "Response must not be empty"
        assert "|----------|-------|--------|" in response, "Response must not be empty"
    ...
    def test_response_includes_top_issues(self):
        ...
        assert ", "Condition must be true"
        assert "Issue 1" in response, "Response must not be empty"
        assert "Issue 2" in response, "Response must not be empty"
    ...
    def test_response_includes_recommended_actions(self):
        ...
        assert ", "Condition must be true"
        assert "codeql-alert-resolution-agent" in response, "Response must not be empty"
    ...
    def test_response_includes_resource_links(self):
        ...
        assert "View Full Dashboard" in response, "Response must not be empty"
        assert "View Full Report" in response, "Response must not be empty"
        assert ".codex/security-findings" in response, "Response must not be empty"
    ...
    def test_response_severity_emoji(self):
        ...
        assert SEVERITY_EMOJI['CRITICAL'] in response, "Response must not be empty"
        assert SEVERITY_EMOJI['HIGH'] in response, "Response must not be empty"
    ...
    def test_response_with_query_info(self):
        ...
        assert "Query" in response, "Response must not be empty"
        assert "CWE-79" in response, "Response must not be empty"
    ...
    def test_response_with_cache_age(self):
        ...
        assert "30m ago" in response, "Response must not be empty"
    ...
    def test_response_with_cache_age_hours(self):
        ...
        assert "2h ago" in response, "Response must not be empty"
    ...
    def test_response_with_package_findings(self):
        ...
        assert "dependency-security-review-agent" in response, "Response must not be empty"
        assert "numpy" in response, "Response must not be empty"
    ...
    def test_response_truncates_long_descriptions(self):
        ...
        assert "A" * 100 not in response, "Response must not be empty"
        assert "..." in response, "Response must not be empty"
    ...
    def test_response_limits_top_findings_to_three(self):
        ...
        assert "showing 3 of 10" in response or "3 of 10" in response, "Response must not be empty"
    ...
    def test_response_with_file_info(self):
        ...
        assert "src/module.py" in response, "Response must not be empty"
        assert "line 42" in response, "Response must not be empty"
...
class TestIntegration:
    ...
    def test_parse_and_generate_workflow(self):
        ...
        assert query is not None, "query must be initialized"
