...
def setup_base():
    ...
    (ART/"capabilities_raw.json").write_text(json.dumps({"capabilities":capabilities}, indent=2), encoding="utf-8")
    ...
    sev = {"counts":{"high":1,"medium":0,"low":0,"total":1},"weights":{"high":0.05,"medium":0.02,"low":0.01}}
...
def test_scoring_enhancements():
    ...
    subprocess.run([sys.executable,"scripts/space_traversal/audit_runner.py","stage","S4"], check=True, env=env)
