...
class TestCheckLegacyConfigUsage:
    ...
    def test_warns_for_legacy_conf_directory(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("codex_ml.config.deprecation.find_repo_root", lambda: repo_root)
    ...
    def test_handles_repo_root_not_found(self, monkeypatch):
        ...
        monkeypatch.setattr("codex_ml.config.deprecation.find_repo_root", mock_find_repo_root)
