...
class TestConfigConsolidation:
    ...
    def test_legacy_config_roots_exist(self):
        ...
        for legacy_root in legacy_roots:
            ...
            assert legacy_path.exists(), f"Legacy config root '{legacy_root}/' must exist for backward compat"
    ...
    def test_configuration_structure_doc_content_quality(self):
        ...
        for section in required_sections:
            assert section in content, f"CONFIGURATION_STRUCTURE.md must contain '{section}' section"
