...
class TestModelValidator:
    ...
    def test_get_last_metrics(self):
        ...
        validator = ModelValidator()
        assert validator.get_last_metrics() is None
...
class TestHyperparameterTuner:
    ...
    def test_create_tuner(self):
        ...
        assert tuner.metric == MetricType.ACCURACY
    ...
    def test_create_tuner_with_metric(self):
        ...
        assert tuner.metric == MetricType.F1_SCORE
    ...
    def test_grid_search(self):
        ...
        assert result.iterations == 4  # 2x2 combinations
    ...
    def test_get_metric_value(self):
        ...
        metrics = ValidationMetrics(accuracy=0.9, precision=0.8)
        assert tuner._get_metric_value(metrics) == 0.8

    def test_get_last_result(self):
        """Test getting last result."""
        tuner = HyperparameterTuner()
        assert tuner.get_last_result() is None
...
class TestPerformanceTracker:
    ...
    def test_create_tracker(self):
        ...
        assert tracker.alert_threshold == 0.15
    ...
    def test_save_and_load(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".json", delete=False) as f:
            ...
            assert len(loaded.get_records()) == 1
...
class TestModelRegistry:
    ...
    def test_create_registry(self):
        ...
        assert registry._production_version is None
    ...
    def test_promote_to_production(self):
        ...
        assert registry.get_production_version().version == "v1.0.0"
    ...
    def test_compare_versions(self):
        ...
        assert abs(comparison["accuracy_diff"] - (-0.1)) < 0.0001  # Float comparison
    ...
    def test_save_and_load(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".json", delete=False) as f:
            ...
            assert "v1.0" in [v.version for v in loaded.list_versions()]
...
class TestTuningPipeline:
    ...
    def test_create_pipeline(self):
        ...
        assert pipeline.tuner is not None
    ...
    def test_auto_promote(self):
        ...
        assert result is True
        assert pipeline.registry.get_production_version().version == "v1.0"
