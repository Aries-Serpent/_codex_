...
class TestConfigValidation:
    ...
    def test_config_range_validation(self):
        ...
        # Range validation
        assert 0 < config['epochs'] < 10000
        assert 0 < config['batch_size'] < 1024
...
class TestConfigMerging:
    ...
    def test_cli_flag_overrides_config(self):
        ...
        assert merged['model'] == 'bert'  # from file
        assert merged['epochs'] == 20     # from CLI override
    ...
    def test_config_precedence_order(self):
        ...
        assert result['setting'] == env_value
...
class TestEnvironmentVariableSupport:
    ...
    def test_env_var_substitution(self):
        ...
        assert os.environ.get('TEST_MODEL') == 'bert'
...
class TestConfigEdgeCases:
    ...
    def test_very_large_config(self):
        ...
        assert 'key_500' in large_config
    ...
    def test_special_characters_in_values(self):
        ...
        assert 'spaces' in config['path']
        assert '@' in config['special']
        assert '世' in config['unicode']
