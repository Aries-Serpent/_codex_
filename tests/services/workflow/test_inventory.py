...
def test_get_triggerable_workflows(temp_workflows_dir, sample_workflow_content, sample_reusable_workflow):
...
def test_get_reusable_workflows(temp_workflows_dir, sample_workflow_content, sample_reusable_workflow):
...
def test_scan_file_extensions(temp_workflows_dir, sample_workflow_content, filename, expected_found):
