    ...
    def test_fluid_channel_reynolds_number(self):
        ...
        try:
            ...
            if hasattr(channel, 'reynolds_number'):
                ...
                re = channel.reynolds_number() if callable(channel.reynolds_number) else channel.reynolds_number
    ...
    def test_fluid_channel_is_turbulent(self):
        ...
        try:
            ...
            if hasattr(channel, 'is_turbulent'):
                result = channel.is_turbulent() if callable(channel.is_turbulent) else channel.is_turbulent
