...
class TestPhysicsGuidedDeveloperOrchestrator:
    ...
    def orchestrator(self):
        ...
        return PhysicsGuidedDeveloperOrchestrator(
            app_type=AppType.PYTHON_CONSOLE
        )
    ...
    def test_component_complexity_tracking(self, orchestrator):
        ...
        complex = CodeComponent("complex.py", "module", "Complex", "# lots of code", complexity_score=0.9)
        
        orchestrator.components = [simple, complex]
        
        avg_complexity = sum(c.complexity_score or 0 for c in orchestrator.components) / len(orchestrator.components)
...
class TestPhysicsIntegration:
    ...
    def test_orchestrator_without_physics(self):
        ...
        orch = PhysicsGuidedDeveloperOrchestrator(
            app_type=AppType.PYTHON_SCRIPT
        )
