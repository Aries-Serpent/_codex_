...
class TestIndexType:
    ...
    def test_index_type_names(self):
        ...
        assert IndexType.FLAT.name == "FLAT"
        assert IndexType.HNSW.name == "HNSW"
        assert IndexType.IVF_FLAT.name == "IVF_FLAT"
        assert IndexType.IVF_PQ.name == "IVF_PQ"
        assert IndexType.HYBRID.name == "HYBRID"
    ...
    def test_index_type_equality(self):
        ...
        assert IndexType.FLAT == IndexType.FLAT
        assert IndexType.HNSW != IndexType.FLAT

    def test_index_type_inequality(self):
        """Test index type inequality."""
        assert IndexType.FLAT != IndexType.HNSW
        assert IndexType.IVF_FLAT != IndexType.IVF_PQ
...
class TestIVFPQIndex:
    ...
    def test_ivfpq_index_initialization_default_config(self):
        ...
        assert index.dimension == 768
        assert index.config is not None
        assert index.config.nlist == 1000
...
class TestConfigConsistency:
    ...
    def test_ivfpq_config_independent_instances(self):
        ...
        assert config1.nlist != config2.nlist
