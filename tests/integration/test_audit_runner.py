...
class TestTrendAggregation:
    ...
    def test_aggregate_weekly_metrics(self):
        ...
        improvements = [
            weeks[i+1]["avg_score"] - weeks[i]["avg_score"]
...
class TestCIIntegration:
    ...
    def test_ci_environment_detection(self):
        ...
        detected = [
            name for name, env_var in ci_indicators.items()
...
class TestMaturityScoreCalculation:
    ...
    def test_mlops_capability_score(self):
        ...
        score = (
            capabilities["implemented"] * 1.0 +
            capabilities["partial"] * 0.5
        ) / capabilities["total"] * 100
