...
class TestConfigToTrainingFlow:
    ...
    def test_training_produces_checkpoint(self, tmp_path):
        ...
        assert loaded_checkpoint["loss"] == 0.456
    ...
    def test_training_metrics_flow_to_evaluation(self):
        ...
        assert eval_context["epochs_trained"] == 4
        assert eval_context["best_train_accuracy"] == 0.85
    ...
    def test_evaluation_runs_after_training(self, tmp_path):
        ...
        assert results["test_accuracy"] == 0.82
    ...
    def test_config_overrides_cascade_correctly(self):
        ...
        assert final_config["learning_rate"] == 0.0001  # Overridden
        assert final_config["batch_size"] == 32  # Original
...
class TestRAGToAgentFlow:
    ...
    def test_rag_embeds_documents(self, tmp_path):
        ...
        assert len(embeddings["doc1"]["embedding"]) == 384
    ...
    def test_rag_builds_index_from_embeddings(self, tmp_path):
        ...
        assert loaded_index["num_documents"] == 2
    ...
    def test_rag_retrieves_relevant_documents(self):
        ...
        assert results[1][0] == "doc3"  # Second highest
    ...
    def test_rag_results_passed_to_agent(self):
        ...
        assert agent_context["retrieved_docs"][0]["score"] == 0.9
    ...
    def test_agent_processes_rag_context(self):
        ...
        assert len(agent_input["context"]) > 0
    ...
    def test_agent_response_includes_citations(self):
        ...
        assert response["citations"][1]["title"] == "DL Tutorial"
    ...
    def test_rag_handles_empty_query(self):
        ...
        assert default_message == "Please provide a query"
    ...
    def test_rag_reranks_retrieved_documents(self):
        ...
        assert reranked[0]["doc"] == "doc2"  # Highest score first
    ...
    def test_agent_streaming_response_with_rag(self):
        ...
        assert "context" in full_response
    ...
    def test_rag_agent_error_recovery(self):
        ...
        assert len(results) == 0
        assert error_message == "Empty query"
...
class TestCLIToCoreFlow:
    ...
    def test_cli_parses_train_command(self):
        ...
        assert parsed_args["model"] == "test-model"
        assert parsed_args["epochs"] == "10"
        assert parsed_args["batch_size"] == "16"
    ...
    def test_cli_config_merges_with_defaults(self):
        ...
        assert final_config["model"] == "default-model"
        assert final_config["epochs"] == 10  # Overridden
        assert final_config["batch_size"] == 16  # Overridden
        assert final_config["learning_rate"] == 0.001
    ...
    def test_cli_validates_arguments(self):
        ...
        assert "Epochs must be positive" in validation_errors
    ...
    def test_cli_progress_updates_during_execution(self):
        ...
        assert "Progress: 0%" in progress_updates[0]
        assert "Progress: 100%" in progress_updates[-1]
    ...
    def test_cli_handles_core_exceptions(self):
        ...
        assert "Core operation failed" in result["message"]
    ...
    def test_cli_supports_json_output_mode(self):
        ...
        assert parsed_output["metrics"]["accuracy"] == 0.87
    ...
    def test_cli_dry_run_mode(self):
        ...
        assert execution_plan[0].startswith("Would execute:")
