...
from cognitive_brain.quantum.adaptive_scoring import AdaptiveScoringOptimizer, ScoringWeights
...
class TestAdaptiveScoringEdgeCases:
    ...
    def test_weights_at_lower_boundary(self):
        ...
        engine = AdaptiveScoringEngine(
            compliance_score_weight=0.0, risk_weight=0.0, learning_rate=0.01
        )
