...
def test_ppo_advantage_calculation():
    ...
    ppo.trajectory = [
        {'state': 's0', 'action': 'a0', 'reward': 1.0, 'next_state': 's1', 
         'done': False, 'value': 0.0, 'action_prob': 0.33},
        {'state': 's1', 'action': 'a1', 'reward': 2.0, 'next_state': 's2',
         'done': False, 'value': 0.0, 'action_prob': 0.33},
        {'state': 's2', 'action': 'a2', 'reward': 3.0, 'next_state': 's3',
         'done': True, 'value': 0.0, 'action_prob': 0.33}
    ]
