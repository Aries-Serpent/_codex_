...
class TestModuleImports:
    ...
    def test_constants_import(self):
        ...
        try:
    from tools.registry import MAX_TOOL_NAME_LENGTH, MAX_TOOLS
...
class TestSafeguards:
    ...
    def test_max_tool_name_length_constant(self):
        ...
        try:
    from tools.registry import MAX_TOOL_NAME_LENGTH
    ...
    def test_max_tools_constant(self):
        ...
        try:
    from tools.registry import MAX_TOOLS
    ...
    def test_logger_configured(self):
        ...
        try:
    from tools.registry import logger
