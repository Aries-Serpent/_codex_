...
def test_crossref_ok(tmp_path):
    report = {
        "snapshot": {
            ...
            "findings": [{"id": "FIND-001", "links": {"capability_ids": ["CAP-001"], "patch_ids": ["PATCH-001"]}}],
            "repro": {"registry": [{"id": "REPRO-001"}]}
        },
        "patches": [{"id": "PATCH-001", "capability_ids": ["CAP-001"], "repro_ids": ["REPRO-001"], "finding_ids": ["FIND-001"]}],
    }
    p = tmp_path / "r.json"
