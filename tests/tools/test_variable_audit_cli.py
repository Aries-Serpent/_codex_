...
# Ensure scripts/tools is importable directly (same pattern as test_variable_management.py)
...
class TestRunAuditMocked:
    ...
    def _make_report_with_live(
        ...
        # We mock at the function level, not token-resolution level,
        # so tests remain independent of the import-time try/except for _resolve_token.
        with (
