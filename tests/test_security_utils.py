...
class TestRedactSensitiveValue:
    """Test redact_sensitive_value function.""" # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret
...
class TestSafeSecretReference:
    ...
    def test_safe_reference_generic_name(self):
        ...
        assert result == "secret: MY_API_KEY"
...
class TestSecurityUtilsIntegration:
    ...
    def test_end_to_end_secret_logging(self):
        ...
        assert "ghp_1234567890" not in safe_message
        assert "abc123def456" not in safe_message
        assert "GOCSPX-secret123" not in safe_message
        assert "GITHUB_TOKEN" not in str(redacted_dict)
        assert "3 secrets" in safe_message or "Configured 3" in safe_message
    ...
    def test_codeql_alert_prevention(self):
        ...
        assert "secret1" not in log_message
        assert "secret2" not in log_message
        assert "value1" not in log_message
...
class TestEdgeCases:
    ...
    def test_special_characters_in_secret_name(self):
        ...
        assert "MY-API_KEY.v2" in result or "[REDACTED" in result
