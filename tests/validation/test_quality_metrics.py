...
class QualityMetricsValidator:
    ...
    def validate_quality_metrics(
        ...
        print("=" * 70)
        print(f"QUALITY METRICS VALIDATION ({phase.upper()})")
        print("=" * 70)
        print()
        ...
        print(f"  Required: ≥{pass_rate_min:.1f}%")
        print(f"  Status:   {'✅ PASS' if pass_rate_valid else '🔴 FAIL'}")
        print()
        ...
        print(f"Test Flakiness:")
        print(f"  Current:  {flakiness:.1f}%")
        print(f"  Max:      ≤{flakiness_max:.1f}%")
        print(f"  Status:   {'✅ PASS' if flakiness_valid else '🔴 FAIL'}")
        print()
        ...
        print(f"Test Determinism:")
        print(f"  Current:  {determinism:.1f}%")
        print(f"  Required: ≥{determinism_min:.1f}%")
        print(f"  Status:   {'✅ PASS' if determinism_valid else '🔴 FAIL'}")
        print()
        ...
        print(f"  Current:  {isolation:.1f}%")
        print(f"  Required: ≥99.5%")
        print(f"  Status:   {'✅ PASS' if isolation_valid else '🔴 FAIL'}")
        print()
        ...
        print(f"Regression Rate:")
        print(f"  Current:  {regression_rate:.1f}%")
        print(f"  Max:      ≤{regression_max:.1f}%")
        print(f"  Status:   {'✅ PASS' if regression_valid else '🔴 FAIL'}")
        print()
