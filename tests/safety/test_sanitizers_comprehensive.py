...
try:
    from codex_ml.safety.sanitizers import (
        SafetyConfig,
        sanitize_output, # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret # pragma: allowlist secret
        sanitize_prompt,
    )
...
class TestAdvancedSecretDetection:
    ...
    def test_multiple_secrets_same_text(self):
        ...
        assert result["flags"]["secrets"] is True
        assert result["redactions"]["secrets"] >= 2
    ...
    def test_secret_redaction_preserves_context(self):
        ...
        assert "for authentication" in result["text"]
        assert "sk-1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKL" not in result["text"]
...
class TestAdvancedPIIDetection:
    ...
    def test_ssn_formats(self):
        ...
        assert result1["flags"]["pii"] is True

        result2 = sanitize_prompt(ssns[1])
        assert result2["flags"]["pii"] is True
...
class TestOutputSanitization:
    ...
    def test_output_truncation_over_limit(self):
        ...
        assert len(result["text"]) == 51  # 50 + ellipsis
...
"""
        ...
        assert result1["flags"]["secrets"] is True
        ...
        assert result3["flags"]["jailbreak"] is True
...
class TestEdgeCasesAndRobustness:
    ...
    def test_empty_input(self):
        ...
        assert result["flags"]["jailbreak"] is False
    ...
    def test_repeated_patterns(self):
        ...
        assert result["flags"]["pii"] is True
        assert result["redactions"]["pii"] >= 10
