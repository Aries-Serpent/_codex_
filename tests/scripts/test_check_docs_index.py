"""
Tests for scripts/ci/check_docs_index.py
...
# ---------------------------------------------------------------------------
# Load the script as a module without importing it via the package hierarchy,
