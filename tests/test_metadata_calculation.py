...
def test_sha256_validation():
    ...
    assert not is_valid_sha256("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b85")  # Too short
    assert not is_valid_sha256("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b8555")  # Too long
...
def test_metadata_json_structure():
    ...
    for file_entry in files:
        ...
        assert is_relative_path(original_path), \
            f"original_path should be relative: {original_path}"
        assert is_relative_path(archived_path), \
            f"archived_path should be relative: {archived_path}"
        
        # Validate SHA256 if present
        if "sha256" in file_entry:
            assert is_valid_sha256(file_entry["sha256"]), \
