...
async def test_bridge_protocol_2_init():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_2_connect():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_2_message():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_2_disconnect():
