"""Test checkpoint manager module 0."""
...
def test_checkpoint_manager_0_init():
...
def test_checkpoint_manager_0_save():
...
def test_checkpoint_manager_0_load():
...
def test_checkpoint_manager_0_list():
