...
async def test_bridge_protocol_6_init():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_6_connect():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_6_message():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_6_disconnect():
