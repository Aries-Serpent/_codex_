"""Test integration shims module 3."""
...
async def test_shim_3_init():
    """Test shim initialization."""
    shim = ExternalServiceShim("service_3")
    assert shim.service_name == "service_3", "service_name is not valid"


@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_3_activate():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_3_shutdown():
    """Test shim shutdown."""
    shim = ExternalServiceShim("service_3")
    await shim.initialize()
