...
async def test_bridge_protocol_5_init():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_5_connect():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_5_message():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_5_disconnect():
