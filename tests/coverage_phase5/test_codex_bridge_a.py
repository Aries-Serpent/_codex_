...
async def test_bridge_protocol_0_init():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_0_connect():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_0_message():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_bridge_protocol_0_disconnect():
