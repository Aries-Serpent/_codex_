"""Test integration shims module 5."""
...
async def test_shim_5_init():
    """Test shim initialization."""
    shim = ExternalServiceShim("service_5")
    assert shim.service_name == "service_5", "service_name is not valid"


@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_5_activate():
...
@pytest.mark.asyncio
@pytest.mark.timeout(30)
async def test_shim_5_shutdown():
    """Test shim shutdown."""
    shim = ExternalServiceShim("service_5")
    await shim.initialize()
