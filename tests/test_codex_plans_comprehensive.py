...
class TestListPlanDocumentsDirectoryStructures:
    ...
    def test_repository_like_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert "CONTRIBUTING.md" in result_names
    ...
    def test_with_version_control_artifacts(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert len(result) == 1
            assert "plan.md" in result_names
...
class TestListPlanDocumentsWithRealWorldPatterns:
    ...
    def test_monorepo_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert "ROADMAP.md" in result_names
            assert "ARCHITECTURE.md" in result_names
    ...
    def test_documentation_site_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert "DEVELOPMENT.md" in result_names
            assert "TESTING.md" in result_names
            assert len(result) == 2
...
class TestListPlanDocumentsConsistency:
    ...
    def test_results_are_deterministic(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert [p.name for p in result1] == [p.name for p in result2]
            assert [p.name for p in result2] == [p.name for p in result3]
    ...
    def test_path_resolution_consistent(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            for path in result:
                ...
                assert path.resolve() == path.resolve()
